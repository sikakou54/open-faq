...
| 関連要件 | [FR-009](../01_specifications/FR-009.md#FR-009)(退会・猶予期間)・[FR-005](../01_specifications/FR-005.md#FR-005)(重要操作前の再認証)・[FR-138](../01_specifications/FR-138.md#FR-138)(猶予期間後のデータ削除)・[FR-141](../01_specifications/FR-141.md#FR-141)(猶予期間中の参照中心運用) |
...
3. オーナーが本人確認(再認証)を行い、退会を確定する。詳細 UC: [UC-SCR-014](UC-SCR-014.md)。関連要件 [FR-005](../01_specifications/FR-005.md#FR-005) ・ [FR-009](../01_specifications/FR-009.md#FR-009)。
4. 退会が受理され、契約が猶予期間(90 日)へ移行する。猶予期間中は管理画面ログインは許可されるが、新規書込みは禁止される(参照中心の運用)。関連要件 [FR-141](../01_specifications/FR-141.md#FR-141)。
5. 猶予期間が経過すると、システムが契約データを物理削除する。詳細 UC: [UC-SYSTEM-003](UC-SYSTEM-003.md#UC-SYSTEM-003)。関連要件 [FR-138](../01_specifications/FR-138.md#FR-138)。

## 6. 例外・代替フロー(業務レベル)

- 退会はオーナー専有のため、メンバーが設定・退会の導線にアクセスした場合は権限不足となる。詳細 UC: [UC-SCR-023](UC-SCR-023.md)。
- 本人確認(再認証)に失敗した場合、退会は確定しない。詳細 UC: [UC-SCR-014](UC-SCR-014.md) ／ 関連要件 [FR-005](../01_specifications/FR-005.md#FR-005)。
- 猶予期間中に退会を取り消した場合(取り消しが可能な範囲)、契約は通常の利用状態へ戻り、物理削除は実行されない。詳細 UC: [UC-SCR-014](UC-SCR-014.md)。
- 猶予期間中の新規書込み操作は禁止され、参照中心の運用に限定される。関連要件 [FR-141](../01_specifications/FR-141.md#FR-141)。
