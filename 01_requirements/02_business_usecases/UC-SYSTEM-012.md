...
| 関連要件 | [FR-091](../01_specifications/FR-091.md#FR-091) 支払い失敗時の猶予とサスペンション ・ [FR-097](../01_specifications/FR-097.md#FR-097) 7 日猶予後の移行 ・ [FR-098](../01_specifications/FR-098.md#FR-098) サスペンション中の制限 |
...
- 猶予経過まで再決済が成立しない契約は `suspended` へ移行し、管理画面は課金・退会のみ、ウィジェット応答は機能停止になる([FR-097](../01_specifications/FR-097.md#FR-097) / [FR-098](../01_specifications/FR-098.md#FR-098))。
- 再決済成功 / 解除の受信で契約は `active` へ即時復帰する([FR-091](../01_specifications/FR-091.md#FR-091))。
