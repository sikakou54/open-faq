...
| 関連要件 | [FR-094](../01_specifications/FR-094.md#FR-094) 上限アラート通知 ・ [FR-093](../01_specifications/FR-093.md#FR-093) リアルタイム集計 |
...
6. 各宛先へ上限アラートメールをメール配信 IF([API-MAIL-001](../../02_basic_design/03_apis/API-mail.md#API-MAIL-001))で送信し、`H_NOTIF_LOGS(C)` に配信ログを記録する([FR-094](../01_specifications/FR-094.md#FR-094))。
