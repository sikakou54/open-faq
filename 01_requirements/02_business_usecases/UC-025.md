...
3. 検証成功時、パスワード再設定確定 API(`POST /auth/password-reset` = [API-AUTH-010](../../02_basic_design/03_apis/API-auth.md#API-AUTH-010))を発行する。
...
| 関連画面イベントID | (P3 で EVT 付与)/ 現行 SCR-003 `EV-07` |
| 関連API ID | [API-AUTH-010](../../02_basic_design/03_apis/API-auth.md#API-AUTH-010) |
