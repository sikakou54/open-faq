...
| 業務ユースケースID | UC-151 |
| 業務ユースケース名 | 初期表示 |
| 対応要件ID | [FR-003](../01_specifications/FR-003.md#FR-003) |
...
| 関連区分 | 内容 |
|---|---|
| 関連画面ID | [SCR-013](../../02_basic_design/01_screens/SCR-013.md#SCR-013) ・ [SCR-002](../../02_basic_design/01_screens/SCR-002.md#SCR-002) |
| 関連画面イベントID | (P3 で EVT 付与)/ 現行 SCR-013 `EV-01` |
| 関連API ID | [API-AUTH-006](../../02_basic_design/03_apis/API-auth.md#API-AUTH-006) |
| 関連テーブルID | `M_CONTRACT` = [TBL-M-002](../../02_basic_design/04_database/TBL-M-002.md) |

## 備考

再構成 P2 で旧 `UC-SCR-013-EV01`(画面 SCR-013 のイベント `EV-01`)から導出。トリガー: EV-01: 初期表示。シーケンス図は P6(SEQ)で保持する。
