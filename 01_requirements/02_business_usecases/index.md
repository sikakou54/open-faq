...
| UC | 起点FR | 名称 |
|---|---|---|
| [UC-248](UC-248.md#UC-248) | [FR-015](../01_specifications/01_account-fr.md#FR-015) | 契約専有機能とプロジェクト利用枠を権限に応じて操作する |
| [UC-249](UC-249.md#UC-249) | [FR-028](../01_specifications/01_account-fr.md#FR-028) | メンバーを別プロジェクトへ追加割当する |
| [UC-250](UC-250.md#UC-250) | [FR-033](../01_specifications/01_account-fr.md#FR-033) | メンバー数しきい値の接近・急増を検知して通知する |
| [UC-251](UC-251.md#UC-251) | [FR-034](../01_specifications/01_account-fr.md#FR-034) | メンバー数アラートの通知先を確定する |
| [UC-252](UC-252.md#UC-252) | [FR-038](../01_specifications/01_account-fr.md#FR-038) | プロジェクト作成者オーナーに全権を付与する |
| [UC-253](UC-253.md#UC-253) | [FR-039](../01_specifications/01_account-fr.md#FR-039) | プロジェクト削除時のメンバー割当と関連データを処理する |
| [UC-254](UC-254.md#UC-254) | [FR-041](../01_specifications/01_account-fr.md#FR-041) | プロジェクト単位で FAQ・質問ログ・未解決質問を分けて管理する |
| [UC-255](UC-255.md#UC-255) | [FR-045](../01_specifications/01_account-fr.md#FR-045) | プロジェクト削除時の関連データ取扱いを確認・選択する |
| [UC-256](UC-256.md#UC-256) | [FR-046](../01_specifications/01_account-fr.md#FR-046) | プロジェクト数の急増を検知してオーナーへ通知する |
| [UC-257](UC-257.md#UC-257) | [FR-060](../01_specifications/02_faq-ai-fr.md#FR-060) | 回答に利用した FAQ を記録し参照提示する |
| [UC-258](UC-258.md#UC-258) | [FR-062](../01_specifications/02_faq-ai-fr.md#FR-062) | 信頼度・関連度しきい値を3階層で調整する |
| [UC-259](UC-259.md#UC-259) | [FR-063](../01_specifications/02_faq-ai-fr.md#FR-063) | 回答不可時に未解決質問を登録し案内する |
| [UC-260](UC-260.md#UC-260) | [FR-064](../01_specifications/02_faq-ai-fr.md#FR-064) | 処理エラー時にエラー表示を行う |
| [UC-261](UC-261.md#UC-261) | [FR-070](../01_specifications/02_faq-ai-fr.md#FR-070) | 未解決質問に必要項目を記録する |
| [UC-262](UC-262.md#UC-262) | [FR-080](../01_specifications/02_faq-ai-fr.md#FR-080) | FAQ 保存・公開と未解決質問の状況を連動させない |
| [UC-263](UC-263.md#UC-263) | [FR-095](../01_specifications/03_usage-fr.md#FR-095) | セキュリティ目的の契約単位レート制限を適用する |
| [UC-264](UC-264.md#UC-264) | [FR-099](../01_specifications/03_usage-fr.md#FR-099) | 課金プロバイダ通知を受信・検証・再処理する |
| [UC-265](UC-265.md#UC-265) | [FR-101](../01_specifications/03_usage-fr.md#FR-101) | 要対応質問の状況を対応中・対応済みで確認する |
| [UC-266](UC-266.md#UC-266) | [FR-102](../01_specifications/03_usage-fr.md#FR-102) | よく聞かれる質問と未解決傾向を確認する |
| [UC-267](UC-267.md#UC-267) | [FR-103](../01_specifications/03_usage-fr.md#FR-103) | 期間絞り込みで集計を参照する |
| [UC-268](UC-268.md#UC-268) | [FR-104](../01_specifications/03_usage-fr.md#FR-104) | 通知失敗・バウンス件数を確認する |
| [UC-269](UC-269.md#UC-269) | [FR-105](../01_specifications/03_usage-fr.md#FR-105) | 管理範囲とユーザー種別に応じて表示範囲を切り替える |
| [UC-270](UC-270.md#UC-270) | [FR-116](../01_specifications/05_notification-fr.md#FR-116) | アカウント認証関連通知をオプトアウト不可とする |
| [UC-271](UC-271.md#UC-271) | [FR-117](../01_specifications/05_notification-fr.md#FR-117) | 送信レート・バウンス率・苦情率を監視して送信抑制する |
| [UC-272](UC-272.md#UC-272) | [FR-118](../01_specifications/05_notification-fr.md#FR-118) | ウィジェット入力文字列を外部露出箇所に使わない |
| [UC-273](UC-273.md#UC-273) | [FR-119](../01_specifications/05_notification-fr.md#FR-119) | 通知配信状態を可視化する |
| [UC-274](UC-274.md#UC-274) | [FR-127](../01_specifications/04_widget-fr.md#FR-127) | 許可ドメイン上でのみウィジェットを動作させる |
| [UC-275](UC-275.md#UC-275) | [FR-135](../01_specifications/04_widget-fr.md#FR-135) | 受付制限中の案内を表示する |
| [UC-276](UC-276.md#UC-276) | [FR-136](../01_specifications/04_widget-fr.md#FR-136) | 未解決時にウィジェット利用者へ案内する |
| [UC-277](UC-277.md#UC-277) | [FR-161](../01_specifications/05_notification-fr.md#FR-161) | お知らせをアカウント利用者のみに表示する |
| [UC-278](UC-278.md#UC-278) | [FR-165](../01_specifications/05_notification-fr.md#FR-165) | お知らせ受信箱を利用者ごとに保持し退会時に削除する |
| [UC-279](UC-279.md#UC-279) | [FR-166](../01_specifications/05_notification-fr.md#FR-166) | 未読件数を遷移時取得し過大負荷なく更新する |
| [UC-280](UC-280.md#UC-280) | [FR-167](../01_specifications/05_notification-fr.md#FR-167) | 一括既読操作を監査ログに記録する |
| [UC-281](UC-281.md#UC-281) | [FR-168](../01_specifications/04_widget-fr.md#FR-168) | FAQ・質問ログを検索する |
