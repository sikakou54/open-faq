...
| 関連要件 | [FR-004](../FR01.md#FR-004) ログイン・ログアウト・パスワード再設定 ・ [FR-007](../FR01.md#FR-007) ログイン試行の失敗回数制限 ・ [FR-008](../FR01.md#FR-008) セッションタイムアウト ・ [FR-101](../FR13.md#FR-101) 規約改定時の再同意 |
...
- **アカウントロックアウト**: 5 回連続失敗で 15 分間ロックされる。15 分の経過、または権限者の手動解除で復旧し、救済導線の案内を受ける。([UC-SYSTEM-014](UC-SYSTEM-014.md#UC-SYSTEM-014) ・ [FR-007](../FR01.md#FR-007))
- **セッション失効**: 無操作 30 分・絶対 12 時間の超過でセッションが失効した場合、次の操作で明示メッセージを受け、再ログインへ誘導される。重要操作では再認証を求められる。([UC-SYSTEM-013](UC-SYSTEM-013.md#UC-SYSTEM-013) ・ [FR-008](../FR01.md#FR-008))
