...
3. 画面はパスワード再設定要求 API([API-AUTH-004](../../02_basic_design/03_apis/API-auth.md#API-AUTH-004))を再発行する。
...
| 関連画面イベントID | (P3 で EVT 付与)/ 現行 SCR-003 `EV-03` |
| 関連API ID | [API-AUTH-004](../../02_basic_design/03_apis/API-auth.md#API-AUTH-004) |
