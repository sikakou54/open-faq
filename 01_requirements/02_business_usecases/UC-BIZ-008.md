...
| 関連要件 | [FR-025](../FR04.md#FR-025) FAQ の登録・編集・削除 ・ [FR-027](../FR04.md#FR-027) 状態管理 ・ [FR-030](../FR04.md#FR-030) 公開前の内容確認 ・ [FR-029](../FR04.md#FR-029) 検索・並び替え・絞り込み ・ [FR-129](../FR16.md#FR-129) FAQ 全文検索 ・ [FR-130](../FR17.md#FR-130) CSV 一括取り込み ・ [FR-131](../FR17.md#FR-131) CSV 書き出し ・ [FR-134](../FR18.md#FR-134) 一括操作の上限 ・ [FR-135](../FR18.md#FR-135) 影響度に応じた確認 |
...
- CSV 取り込みを行う場合、取り込み対象が CSV(UTF-8、ヘッダ行あり、1 ファイル最大 1000 件)である([FR-130](../FR17.md#FR-130))。
...
3. 個別整備では、メンバーが公開前に質問・回答・状態を確認し([FR-030](../FR04.md#FR-030))、状態を「公開中」にして保存する。
...
- **同時編集の衝突(個別)**: 他メンバーが同一 FAQ を更新済みのとき、衝突を検出して再読み込みを促し、上書きを防ぐ([FR-132](../FR18.md#FR-132))。
- **一括操作の上限超過**: 1 操作あたり FAQ の一括状態変更が 50 件を超えるとき、上限超過として受け付けない([FR-134](../FR18.md#FR-134))。
- **一括削除の確認**: 削除は復元できないため、確認を経てから実行する([FR-135](../FR18.md#FR-135))。
- **CSV 受付形式不正**: CSV 以外 / UTF-8 不正 / ヘッダ欠落 / 件数上限超過のとき、受付前に拒否しジョブを起動しない([UC-SYSTEM-001](UC-SYSTEM-001.md#UC-SYSTEM-001))。
- **CSV 部分失敗**: 一部の行が失敗しても成功分は反映し、失敗行と理由をメンバーが確認できる([FR-130](../FR17.md#FR-130))。
