...
| 関連要件 | [FR-083](../FR11.md#FR-083) 通知再送 ・ [FR-089](../FR11.md#FR-089) 再送回数上限 |
...
3. 各対象について再送可否を判定する。
   ...
   2. 再送回数が上限([FR-089](../FR11.md#FR-089))未満であること。
...
- 再送可能な対象は上限の範囲内で再送され、配信状態が更新される([FR-083](../FR11.md#FR-083))。
