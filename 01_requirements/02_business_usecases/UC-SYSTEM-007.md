<!-- portal-top -->
[設計ポータル](../../README.md) ／ [要件定義](../index.md) ／ [業務ユースケース](index.md) ／ **UC-SYSTEM-007: メンバー割当変更通知**
<!-- /portal-top -->
...
| 関連要件 | [FR-125](../01_specifications/FR-125.md#FR-125) メンバー割当変更通知 ・ [FR-014](../01_specifications/FR-014.md#FR-014) メンバーのプロジェクト割当 |
| 主テーブル | `T_INBOX_MSG(C)` ・ `H_NOTIF_LOGS(C)` |
| 関連 API | [API-MBR-001](../../02_basic_design/03_apis/API-member.md#API-MBR-001) メンバー管理(契機操作) ・ [API-MAIL-001](../../02_basic_design/03_apis/API-mail.md#API-MAIL-001) メール配信 IF |
