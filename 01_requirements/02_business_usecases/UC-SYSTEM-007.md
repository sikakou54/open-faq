...
| 関連要件 | [FR-087a](../FR11.md#FR-087a) メンバー割当変更通知 ・ [FR-012b](../FR02.md#FR-012b) メンバーのプロジェクト割当 |
...
3. 対象メンバーのお知らせ受信箱 `T_INBOX_MSG(C)` に「運営お知らせ」種別・「通常」重要度のお知らせを生成する([FR-087a](../FR11.md#FR-087a))。
...
- 対象メンバーの受信箱に「運営お知らせ」種別・「通常」重要度の割当変更お知らせが生成される([FR-087a](../FR11.md#FR-087a))。
