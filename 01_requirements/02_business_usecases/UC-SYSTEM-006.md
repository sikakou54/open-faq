...
| 関連要件 | [FR-091a](../FR11.md#FR-091a) システム通知の自動生成 ・ [FR-082](../FR11.md#FR-082) 契機による通知 |
...
3. サブ契機に応じた件名・本文でお知らせ受信箱 `T_INBOX_MSG(C)` に「システム通知」のお知らせを生成する([FR-091a](../FR11.md#FR-091a))。
4. メール送信対象の契機かを判定する。
...
- 対象アカウント利用者の受信箱に「システム通知」のお知らせが生成される([FR-091a](../FR11.md#FR-091a))。
