...
| 業務ユースケースID | UC-181 |
| 業務ユースケース名 | 初期表示 |
| 対応要件ID | [FR-018](../01_specifications/FR-018.md#FR-018) |
| 主アクター | 招待メンバー(トークン) |
...
| 関連画面イベントID | (P3 で EVT 付与)/ 現行 SCR-018 `EV-01` |
| 関連API ID | [API-AUTH-007](../../02_basic_design/03_apis/API-auth.md#API-AUTH-007) |
| 関連テーブルID | `T_ACCESS_TOKENS` = [TBL-T-002](../../02_basic_design/04_database/TBL-T-002.md) |

## 備考

再構成 P2 で旧 `UC-SCR-018-EV01`(画面 SCR-018 のイベント `EV-01`)から導出。トリガー: EV-01: 初期表示。シーケンス図は P6(SEQ)で保持する。
