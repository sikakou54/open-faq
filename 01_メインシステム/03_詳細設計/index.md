...
|---|---|---|---|
| [DD01_アカウント・ユーザー管理.md](DD01_アカウント・ユーザー管理.md) | アカウント・ユーザー管理 | FR-001〜022 | §4 / §6 SCR-001〜003,017 / §7 |
| [DD02_プロジェクト・FAQ管理.md](DD02_プロジェクト・FAQ管理.md) | プロジェクト・FAQ 管理 | FR-040〜048 / FR-100〜103, FR-105, FR-106 | §6 SCR-010〜012 / §7 / §9 |
...
| [DD06_個別チャット.md](DD06_個別チャット.md) | 個別チャット | FR-080〜091 | §6 SCR-013 / §7 |
...
| [DD12_利用量計測・課金.md](DD12_利用量計測・課金.md) | 利用量計測・課金 | FR-120〜127 / FR-139 | §6 SCR-015 / §7 / §13.7-13.8 |
| [DD13_ウィジェット配信.md](DD13_ウィジェット配信.md) | ウィジェット配信 | FR-150〜156 / FR-083 / 084 | §6 SCR-014,027 / §7 |
...
データ保持期間は **システム固定値**（NFR-702、UI 上の変更不可）。SCR-016 にデータ保持期間設定 UI は存在しない（[01_画面設計.md §5.11](../02_基本設計/01_画面設計.md) 参照）。
...
調整制約は [03_テーブル設計.md §10](../02_基本設計/03_テーブル設計.md) を正本。短縮は法令・契約義務範囲内でサポート窓口経由運営者対応、長期化は将来要件（FUT 配下）で再検討。
