...
| 作成日 | 2026-05-17 |
| ステータス | 承認済 |
| 入力文書 | [../01_要件定義/index.md](../01_要件定義/index.md) / [../02_基本設計/index.md](../02_基本設計/index.md) / 画面遷移図([オーナー](../画面遷移図_オーナー.html) / [プロジェクト管理者](../画面遷移図_プロジェクト管理者.html) / [プロジェクトメンバー](../画面遷移図_プロジェクトメンバー.html) / [ウィジェット利用者](../画面遷移図_ウィジェット利用者.html))|
...
| 画面遷移図(アカウント種別別)| [オーナー](../画面遷移図_オーナー.html) / [プロジェクト管理者](../画面遷移図_プロジェクト管理者.html) / [プロジェクトメンバー](../画面遷移図_プロジェクトメンバー.html) / [ウィジェット利用者](../画面遷移図_ウィジェット利用者.html) | 画面レイアウト、画面目的、権限、入出力、遷移、例外の視覚情報 |
...
│   ├── export.ts             # データエクスポート生成(契約全データは将来対応 / FAQ CSV のみ MVP)
...
|---|---|---|---|
| [DD01_アカウント・ユーザー管理.md](DD01_アカウント・ユーザー管理.md) | アカウント・ユーザー管理 / フロント URL ルーティング / 利用状況の空状態 | FR-001〜022 / FR-325〜327 | §4 / §6 SCR-001〜003,009,016,017,023 / §7 |
...
| [DD11_利用量計測・課金.md](DD11_利用量計測・課金.md) | 利用量計測・課金 | FR-120〜127 / FR-139 | SCR-016 利用状況 / SCR-021 プロジェクト利用量 / SCR-022 請求 |
...
データ保持期間は **システム固定値**（NFR-702、UI上の変更不可）。SCR-017個人設定およびSCR-023設定に変更UIは設けない。
