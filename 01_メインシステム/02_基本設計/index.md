...
| SCR-015-M1 | 月次上限件数・アラート設定モーダル(SCR-015 課金部から起動)| §5.SCR-015-M1 | `PATCH /v1/billing/monthly-usage-limits` | `owner_quota_overrides` | オーナー専有 | E-AUTHZ-OWNER-ONLY / E-INPUT-* | MSG-SCR-015-M1-* | §6 認可判定 | §7 再認証 | §3 契約上書き |
