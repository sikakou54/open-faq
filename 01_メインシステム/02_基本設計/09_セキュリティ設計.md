...
- **最小権限原則**(オーナー専有 / 権限フラグ / プロジェクト割当の三段階)
...
| **管理者権限の濫用防止** | 監査ログ全件 + メンバー権限フラグの最小化 + オーナー専有機能の `account_permissions` 付与不可 | [05_権限設計書.md](05_権限設計書.md) / §7 |
