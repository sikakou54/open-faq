...
const catalog = {
  ...
  "scr-012-m1": {
    ...
    condition: "SCR-012のCSVインポートから起動。FAQ権限が必要。",
  },
  "scr-013-admin": {
    purpose: "対象プロジェクトのチャット部屋と未読状況を一覧する。",
    condition: "対象プロジェクトへの割当とチャット対応またはログ参照権限。",
  },
  "scr-033": {
    purpose: "エンドユーザーとの会話を確認し、返信・担当変更を行う。",
    condition: "SCR-013の対象行から遷移。対象プロジェクトへの割当が必要。",
  },
  "scr-034": {
    purpose: "新規チャットのデフォルト担当者を設定する。",
  ...
  "scr-013-eu": {
    purpose: "ウィジェット利用者が自分のチャット履歴を確認し、返信する。",
    condition: "本人のチャットセッションまたは有効な再入室トークン。",
  },
  "scr-014": {
  ...
  "scr-017-m1": {
    ...
    condition: "SCR-017から起動。対象プロジェクトの管理者以上。",
  },
  "scr-018": {
  ...
  "scr-027": {
    purpose: "メールの専用リンクから自分のチャットへ再入室する。",
    condition: "有効な再入室トークン。期限切れ時は再送。",
  },
  "widget-enduser": {
    purpose: "導入サイト上でFAQ検索・質問を行い、必要に応じて問い合わせる。",
...
const roles = [
  {
    ...
    title: "ウィジェット利用者",
    subtitle: "導入サイトでFAQ・質問・チャットを利用するエンドユーザー",
    description:
      "管理コンソールのアカウントを持たず、導入サイトに埋め込まれたウィジェットと本人用チャットだけを利用します。管理画面、設定、契約情報にはアクセスしません。",
    color: "#0f766e",
    screens: [
      "widget-enduser",
      "scr-013-eu",
    ...
    access: {
      "widget-enduser": "質問・FAQ検索。上限到達時は問い合わせ先を確認",
      "scr-013-eu": "本人のチャット閲覧・投稿のみ",
      "scr-027": "本人の再入室リンク検証と再送",
      "scr-018": "公開URLで閲覧",
      "scr-035": "公開URLで閲覧",
    },
    flows: [
      {
        name: "FAQ質問・問い合わせ",
        steps: ["WIDGET 質問", "AI回答 / 要対応化", "SCR-013 本人チャット"],
        condition: "質問受付中で、許可ドメインから利用していること。",
      },
      {
        name: "チャット再入室",
        steps: ["再入室メール", "SCR-027 トークン確認", "SCR-013 本人チャット"],
        condition: "トークンが有効期限内。期限切れ時は新リンクを再送。",
      },
      {
        name: "質問上限到達",
    ...
    differences: [
      ...
      ["チャット", "本人のみ", "専用リンクまたは本人セッションで特定された部屋だけ"],
      ["利用規約・ポリシー", "公開閲覧", "認証不要URLから本文のみ表示"],
      ["質問受付", "状態依存", "上限到達・契約停止時は新規質問を受け付けない"],
    ],
    excluded: [
      "SCR-001〜003、SCR-021〜026、SCR-028、SCR-031〜042の管理コンソール画面",
      "FAQ編集、メンバー管理、ウィジェット設定、利用量設定",
      "契約・請求・退会・操作履歴",
    ],
    notes: [
      "SCR-018 / SCR-035は既存画面の認証不要版として、管理サイドバーを除いた本文表示にしています。",
  ...
  },
  {
    ...
    description:
      "担当プロジェクトのFAQ、要対応質問、チャット、ログを扱います。メンバー招待・ロール変更、上限変更、プロジェクト設定、契約管理は行いません。",
    color: "#2563eb",
    screens: [
      "scr-031",
      "scr-001",
    ...
    access: {
      ...
      "scr-003": "自分のパスワード再設定",
      "scr-015": "担当プロジェクトの概要",
      "scr-011-list": "閲覧・絞り込み・出力",
      "scr-011-detail": "閲覧・対応状況更新",
      "scr-012-list": "FAQ一覧・公開管理・CSV操作",
      "scr-012-edit": "FAQ編集",
      "scr-012-m1": "FAQ CSVインポート",
      "scr-013-admin": "チャット一覧",
      "scr-033": "返信・担当変更",
      "scr-014": "閲覧・埋め込みコードコピーのみ",
      "scr-036": "閲覧のみ",
      "scr-021": "自契約のお知らせ閲覧",
      "scr-022": "お知らせ詳細閲覧",
      "scr-028": "自分のプロフィール・セキュリティ",
      "scr-018": "閲覧",
      "scr-035": "閲覧",
    },
    flows: [
      {
        name: "招待から利用開始",
        steps: ["招待メール", "SCR-031 有効化", "SCR-001 ログイン", "SCR-015 概要"],
        condition: "有効な招待トークンと、氏名・パスワード・規約同意の完了。",
      },
      {
        name: "要対応質問からFAQ化",
        steps: ["SCR-015", "SCR-011 一覧", "SCR-011 詳細", "SCR-012 FAQ編集"],
        condition: "担当プロジェクトへの有効な割当。",
      },
      {
        name: "チャット対応",
        steps: ["SCR-015", "SCR-013 一覧", "SCR-033 返信・担当変更"],
        condition: "チャット対応またはログ参照権限。",
      },
      {
        name: "利用状況確認",
        steps: ["SCR-015", "SCR-036 閲覧", "管理者へ変更依頼"],
        condition: "メンバーは上限とアラートを変更できない。",
      },
    ],
    differences: [
      ["FAQ・質問・チャット", "編集・対応可", "担当プロジェクト内に限定"],
    ...
    excluded: [
      "SCR-017 / SCR-017-M1 メンバー管理",
      "SCR-034 自動割り当て、SCR-036-M1 上限設定、SCR-042 プロジェクト設定",
      "SCR-010 / SCR-024〜026 / SCR-037〜041の契約・オーナー専用画面",
      "SCR-002 / SCR-023の新規オーナー登録フロー",
    ],
    notes: [
      "SCR-014は既存ワイヤーフレームから設定保存・公開キー再発行を除外し、読み取り専用として掲載しています。",
      "SCR-028からオーナー専用の契約連絡先・退会パネルを除外しています。",
    ],
  },
  {
    slug: "プロジェクト管理者",
    ...
    description:
      "プロジェクトメンバーの全操作に加え、担当プロジェクトのメンバー招待・ロール変更、自動割り当て、ウィジェット設定、質問数上限設定を行います。契約・請求・退会は扱いません。",
    color: "#7c3aed",
    screens: [
      "scr-031",
      "scr-001",
    ...
    access: {
      ...
      "scr-033": "返信・担当変更",
      "scr-034": "デフォルト担当者設定",
      "scr-014": "設定保存・公開キー再発行",
      "scr-017": "担当プロジェクトのメンバー一覧",
      "scr-017-m1": "招待・ロール変更・割当解除",
      "scr-036": "閲覧・設定画面起動",
      "scr-036-m1": "上限・通知閾値変更",
      "scr-042": "参照のみ",
      "scr-032": "連絡先メール所有者が確認",
      "scr-021": "自契約のお知らせ閲覧",
      "scr-022": "お知らせ詳細閲覧",
      "scr-028": "自分のプロフィール・セキュリティ",
      "scr-018": "閲覧",
    ...
    flows: [
      ...
      {
        name: "メンバー管理",
        steps: ["SCR-015", "SCR-017 一覧", "SCR-017-M1 招待・編集"],
        condition: "担当プロジェクト内のみ。契約からのアカウント削除は不可。",
      },
      {
        name: "上限・アラート設定",
        steps: ["SCR-015", "SCR-036", "SCR-036-M1", "再認証・保存"],
        condition: "対象プロジェクトのadminロールと再認証。",
      },
      {
        name: "連絡先メール確認",
        steps: ["SCR-042 参照", "オーナーが確認メール送信", "SCR-032 所有者確認"],
        condition: "SCR-042の編集・送信操作はオーナーが実施。",
      },
    ],
    differences: [
      ["FAQ・質問・チャット", "編集・対応可", "担当プロジェクト内に限定"],
    ...
    excluded: [
      "SCR-010 / SCR-010-M1 プロジェクト作成",
      "SCR-024〜026 / SCR-037〜041の契約・課金・退会・監査画面",
      "SCR-039の契約メンバー管理とアカウント削除",
      "SCR-002 / SCR-023の新規オーナー登録フロー",
    ],
    notes: [
      "SCR-042は権限設計の正本に合わせ、編集ボタン・確認メール送信・削除パネルを除外した参照版です。",
      "SCR-032の実操作者はプロジェクト管理者本人とは限らず、連絡先メールの所有者です。設定フローとの関係から本ページにも掲載しています。",
      "SCR-028からオーナー専用の契約連絡先・退会パネルを除外しています。",
    ],
  },
  {
    ...
    flows: [
      {
        name: "新規契約開始",
        steps: ["SCR-002 登録", "SCR-023 メール確認", "SCR-001 ログイン", "SCR-026 契約概要"],
        condition: "メール確認と初回規約同意が完了していること。",
      },
      {
        name: "プロジェクト作成・運用",
        steps: ["SCR-026", "SCR-010", "SCR-010-M1 作成", "SCR-015 プロジェクト概要"],
        condition: "契約オーナー。作成後は自動でプロジェクト管理者となる。",
      },
      {
        name: "契約管理",
        steps: ["SCR-026", "SCR-037 利用状況", "SCR-038 料金・請求", "SCR-041 契約設定"],
        condition: "契約ワークスペース内のオーナー専有導線。",
      },
      {
        name: "退会",
        steps: ["SCR-041", "SCR-024 影響確認", "再認証", "退会申請"],
        condition: "契約オーナーのみ。全プロジェクト・全メンバーへ影響。",
      },
      {
        name: "規約再同意",
        steps: ["SCR-001", "SCR-025 強制割込み", "同意 / 退会判断", "SCR-026"],
    ...
    excluded: [
      "WIDGET / SCR-013(EU側) / SCR-027のエンドユーザー本人向け画面",
      "SCR-031の招待メンバー有効化画面（オーナー自身は新規登録フローを利用）",
      "運営者システム主管のSCR-090〜099",
    ],
    notes: [
      "SCR-032の実操作者は連絡先メール所有者ですが、オーナーが設定・確認メール送信を管理するためフローに含めています。",
...
function roleSpecificBlock(role, id) {
  ...
  if (role.audienceKey === "widget-user" && ["scr-018", "scr-035"].includes(id)) {
    return makePublicLegalView(html);
  }

  if (["project-member", "project-admin"].includes(role.audienceKey) && id === "scr-028") {
  ...
  if (role.audienceKey === "project-admin" && id === "scr-042") {
  ...
  if (role.audienceKey === "owner" && id === "scr-032") {
    html = addScreenNote(
      html,
  ...
  if (role.audienceKey === "project-admin" && id === "scr-032") {
    html = addScreenNote(
      html,
...
<main class="role-document">
  ...
  <div class="doc-grid" id="common">
    <section class="doc-section">
      <h2>共通画面</h2>
      <ul class="plain-list">
        <li>全利用者共通: SCR-018 利用規約、SCR-035 プライバシーポリシー</li>
        <li>認証ユーザー共通: SCR-001 ログイン、SCR-003 パスワード再設定、SCR-021 / 022 お知らせ、SCR-028 個人設定</li>
        <li>プロジェクト運用共通: SCR-015、SCR-011、SCR-012、SCR-013 / 033、SCR-014、SCR-036</li>
        <li>招待メンバー共通: SCR-031 アカウント有効化</li>
      </ul>
    </section>
    <section class="doc-section">
      <h2>専用・高権限画面</h2>
      <ul class="plain-list">
        <li>ウィジェット利用者専用: WIDGET、SCR-013(EU側)、SCR-027</li>
        <li>プロジェクト管理者以上: SCR-017 / M1、SCR-034、SCR-036-M1</li>
        <li>オーナー専用: SCR-002 / 023、SCR-010 / M1、SCR-024〜026、SCR-037〜041</li>
        <li>SCR-042: オーナーは編集・削除、プロジェクト管理者は参照のみ</li>
      </ul>
    </section>
  </div>
  ...
  <section class="doc-section">
    ...
    <table class="role-table">
      ...
      <tbody>
        <tr><td>SCR-002 / SCR-023</td><td>オーナー</td><td>画面ヘッダは「管理者」表記ですが、画面設計の目的が「新規利用者(オーナー)」の登録と明記されているため。</td></tr>
        <tr><td>SCR-025 規約再同意</td><td>オーナー</td><td>既存ワイヤーフレームはオーナー / メンバー表記ですが、権限設計・要件・トレーサビリティでは契約判断としてオーナー専有のため。</td></tr>
        <tr><td>SCR-032 連絡先メール確認</td><td>オーナー / プロジェクト管理者の関連フロー</td><td>実操作者はアカウント不要のメール所有者ですが、設定と完了確認を行う管理ロール側にも必要なため。</td></tr>
        <tr><td>SCR-042 プロジェクト設定</td><td>管理者は参照、オーナーは編集・削除</td><td>既存ワイヤーフレームには編集操作がありますが、権限設計の正本を優先したため。</td></tr>
        <tr><td>SCR-018 / SCR-035</td><td>全4種別</td><td>認証不要URLが提供されるため、ウィジェット利用者にも公開閲覧版を含めたため。</td></tr>
      </tbody>
    </table>
  </section>
