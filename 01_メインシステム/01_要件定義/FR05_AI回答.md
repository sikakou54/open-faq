...
| 版数 | v1.4 |
| ステータス | 承認済 |
| 更新履歴 | v1.4(2026-06-14): ウィジェット返信から問い合わせID表示を削除 / v1.3(2026-06-12): 未解決時は問い合わせIDと連絡先案内を表示 |
...
| FR-056 | FAQ登録済みデータでは回答できなかった場合、管理用の問い合わせ ID を付与して未解決質問を登録し、同じウィジェットの会話欄へは回答できなかった旨・確認済みプロジェクト連絡先メール(設定済みの場合)を表示すること。問い合わせ ID はウィジェットに表示せず、FAQ 質問入力は継続可能とすること | P0 |
