...
| SCR-016 | 設定(退会・課金画面入口) | オーナー専有(契約ワークスペース内) | FR-009, FR-125, FR-162, FR-167 | P0 | メイン |
| SCR-017 | ユーザー管理(一覧 / 契約ワークスペースでは全プロジェクト横断、プロジェクトワークスペースでは当該プロジェクト範囲の 2 視点) | 管理者ユーザー(オーナー / プロジェクト管理者) | FR-017, FR-021a〜c | P0 | メイン |
...
| SCR-028 | プロフィール(自分の表示名・メール・パスワード変更) | 全管理者ユーザー | FR-001, FR-005, FR-006 | P0 | メイン |
| SCR-029 | 割当ゼロホーム(プロジェクト割当 0 件のメンバー専用ランディング) | プロジェクト割当ゼロのメンバー | FR-015d, FR-337, FR-339 | P0 | メイン |
| SCR-030 | プロジェクト個別設定(通知宛先・チャネル等のプロジェクトワークスペース内設定) | プロジェクト管理者(`admin`) | FR-031, FR-145〜146a | P1 | メイン |
