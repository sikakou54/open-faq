...
<td>初期表示</td>
<td><ul>
<li><a href="API-terms.md#API-TRM-001">利用規約 最新版取得</a> API と <a href="API-terms.md#API-TRM-002">プライバシーポリシー 最新版取得</a> API で改定文書の差分サマリを取得</li>
...
<td>「同意して続行する」を押下</td>
<td><ul>
<li>成功時: 改定対象の文書のみを対象に <a href="API-terms.md#API-TRM-003">利用規約 同意</a> API / <a href="API-terms.md#API-TRM-004">プライバシーポリシー 同意</a> API を呼び出し <code>T_TERMS_AGREE</code> に記録。完了後は割込み前の操作へ戻る</li>
