<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-019 プロジェクト連絡先メール確認完了**
<!-- /portal-top -->
...
| 関連 | 内容 |
|----|----|
| FR / BR | FR-022a, FR-022c, FR-092〜FR-098 / — |
...
本画面が更新するテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../03_database-design/index.md)、API の正本は [API設計](../02_api-design/index.md) です。
...
<td>◯</td>
<td>—</td>
<td><code>M_PROJECTS</code>(<a href="../03_database-design/index.md#TBL-M-004">テーブル設計 3.6</a>)</td>
</tr>
<tr>
<td>アクセストークン</td>
...
<td>◯</td>
<td>—</td>
<td><code>T_ACCESS_TOKENS</code>(<a href="../03_database-design/index.md#TBL-T-002">テーブル設計 3.5</a>)</td>
</tr>
<tr>
<td>連絡先メール確認</td>
...
<td>—</td>
<td>—</td>
<td><a href="../02_api-design/API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a>(API-AUTH-009)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li>URL パスパラメータのトークンを取得し、<a href="../02_api-design/API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a> API (POST /auth/contact-verifications/{token}) を呼び出す</li>
