<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-011 お知らせ一覧**
<!-- /portal-top -->
...
| 関連     | 内容                                   |
|----------|----------------------------------------|
| FR / BR  | FR-116〜FR-119, FR-134, FR-135 / BR-107        |
...
本画面が読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../03_database-design/index.md)、API の正本は [API設計](../02_api-design/index.md) です。
...
<td>—</td>
<td>—</td>
<td><code>M_SERVICE_ANNOUNCE</code>(<a href="../03_database-design/index.md#TBL-M-010">テーブル設計 3.25</a>)</td>
</tr>
<tr>
<td>お知らせ受信状態</td>
...
<td>◯</td>
<td>—</td>
<td><code>T_ANNOUNCE_RCPT</code>(<a href="../03_database-design/index.md#TBL-T-009">テーブル設計 3.27</a>)</td>
</tr>
<tr>
<td>お知らせ一覧取得</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /me/announcements</code>(<code>cursor</code>)(<a href="../02_api-design/API-inbox.md#API-ANN-001">API-ANN-001 お知らせ一覧</a>)</td>
</tr>
<tr>
<td>お知らせ個別既読化</td>
<td>個別のお知らせを既読化する</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /me/announcements/{id}/read</code>(<a href="../02_api-design/API-inbox.md#API-ANN-002">API-ANN-002 お知らせ個別既読</a>)</td>
</tr>
<tr>
<td>お知らせ一括既読</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /me/announcements/read</code>(<a href="../02_api-design/API-inbox.md#API-ANN-003">API-ANN-003 お知らせ一括既読</a>)</td>
</tr>
<tr>
<td>未読件数取得</td>
<td>未読件数サマリを取得する</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /me/announcements/unread-summary</code>(<a href="../02_api-design/API-inbox.md#API-ANN-004">API-ANN-004 お知らせ未読件数</a>)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li><a href="../02_api-design/API-inbox.md#API-ANN-001">お知らせ一覧</a> API でクイックフィルタ「未読のみ」を既定条件として一覧を取得し表示する</li>
<li><a href="../02_api-design/API-inbox.md#API-ANN-004">お知らせ未読件数</a> API で未読件数を取得し件数表示(IT-04)を更新する</li>
...
<td><ul>
<li>選択した条件を付与して <a href="../02_api-design/API-inbox.md#API-ANN-001">お知らせ一覧</a> API を再取得し一覧を更新する</li>
<li>0 件時: 空状態(IT-17)を表示する</li>
</ul></td>
</tr>
<tr>
...
<td>「すべてクリア」を押下</td>
<td><ul>
<li>適用中のフィルタ条件をすべて解除して <a href="../02_api-design/API-inbox.md#API-ANN-001">お知らせ一覧</a> API を再取得し一覧を更新する</li>
...
<td>詳細フィルタを適用</td>
<td><ul>
<li>期間を選択(開始日 / 終了日)またはキーワードを入力し、条件を付与して <a href="../02_api-design/API-inbox.md#API-ANN-001">お知らせ一覧</a> API を再取得し一覧を更新する</li>
<li>0 件時: 空状態(IT-17)を表示する</li>
</ul></td>
</tr>
<tr>
...
<td>行を選択</td>
<td><ul>
<li>チェックをオンにした行を一括操作の対象として選択状態にする(最大 100 件: FR-134)</li>
...
<td><ul>
<li><a href="../02_api-design/API-inbox.md#API-ANN-002">お知らせ個別既読</a> API で該当行を既読化する</li>
<li>詳細画面(SCR-012)へ遷移する</li>
...
<td>「既読化する」を押下</td>
<td><ul>
<li>選択行を <a href="../02_api-design/API-inbox.md#API-ANN-003">お知らせ一括既読</a> API で既読化する</li>
...
<td><ul>
<li>現在のフィルタ条件を維持したまま <a href="../02_api-design/API-inbox.md#API-ANN-003">お知らせ一括既読</a> API で表示中の未読を既読化する</li>
...
<td><ul>
<li>確認ダイアログを表示する(FR-135)</li>
<li>OK 押下時: フィルタを無視して <a href="../02_api-design/API-inbox.md#API-ANN-003">お知らせ一括既読</a> API で全未読を既読化する</li>
<li>成功時: 一覧を再取得し未読件数(IT-04)を更新する</li>
...
<td>「次のページ」を押下</td>
<td><ul>
<li>カーソル方式で <a href="../02_api-design/API-inbox.md#API-ANN-001">お知らせ一覧</a> API の次ページを取得し、一覧に追記表示する</li>
