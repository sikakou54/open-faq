...
| 関連 | 内容 |
|----|----|
| FR / BR | FR-025〜FR-033, FR-053〜FR-056, FR-057, FR-058, FR-132〜FR-135 / BR-028 |
...
本画面が読み書きするテーブル・ファイルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../03_database-design/index.md)、API の正本は [API設計](../02_api-design/index.md#API-FAQ-001) です。
...
<td>—</td>
<td>—</td>
<td><code>GET /faqs</code>(<code>status</code> / <code>projectId</code> / <code>keyword</code> / <code>cursor</code>)(<a href="../02_api-design/API-faq.md#API-FAQ-001">FAQ 一覧</a>)</td>
</tr>
<tr>
<td>FAQ 作成・更新・削除</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /faqs/bulk-status</code>(<a href="../02_api-design/API-faq.md#API-FAQ-003">FAQ 一括状態変更</a>)</td>
</tr>
<tr>
<td>FAQ エクスポート</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /faqs/export</code>(<a href="../02_api-design/API-faq.md#API-FAQ-006">FAQ CSV エクスポート</a>)</td>
</tr>
<tr>
<td>FAQ CSV</td>
...
<td>初期表示</td>
<td><ul>
<li><a href="../02_api-design/API-faq.md#API-FAQ-001">FAQ 一覧</a> API で一覧を取得し表示</li>
...
<td>キーワードを入力</td>
<td>キーワードを付与して <a href="../02_api-design/API-faq.md#API-FAQ-001">FAQ 一覧</a> API を再取得し一覧を更新</td>
</tr>
<tr>
<td><code>EV-03</code></td>
<td><a href="#IT-02">IT-02</a></td>
<td>カテゴリを選択</td>
<td>カテゴリ条件を付与して <a href="../02_api-design/API-faq.md#API-FAQ-001">FAQ 一覧</a> API を再取得し一覧を更新</td>
</tr>
<tr>
<td><code>EV-04</code></td>
<td><a href="#IT-03">IT-03</a></td>
<td>並び順を変更</td>
<td>指定した並び順で <a href="../02_api-design/API-faq.md#API-FAQ-001">FAQ 一覧</a> API を再取得し一覧を更新</td>
</tr>
<tr>
...
<td>「公開する」を押下</td>
<td><ul>
<li>選択中 FAQ を <a href="../02_api-design/API-faq.md#API-FAQ-003">FAQ 一括状態変更</a> API で一括公開(status=published)する</li>
...
<td>「非公開化する」を押下</td>
<td><ul>
<li>選択中 FAQ を <a href="../02_api-design/API-faq.md#API-FAQ-003">FAQ 一括状態変更</a> API で一括非公開化(status=hidden)する</li>
<li>成功: 一覧を再取得して表示を更新し、選択を解除する</li>
<li>失敗行あり: 失敗件数と理由をトースト通知で表示する</li>
</ul></td>
</tr>
...
<li>ダイアログで確認 OK: 選択中 FAQ を論理削除する(一括削除 API 未定義のため、各 FAQ ID に対して <a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> API の DELETE を順次実行する)</li>
<li>成功: 一覧を再取得して表示を更新し、選択を解除する</li>
...
<td><ul>
<li><a href="../02_api-design/API-faq.md#API-FAQ-006">FAQ CSV エクスポート</a> API でフィルタ適用結果を CSV として取得しダウンロードする</li>
<li>失敗: エラートーストを表示する</li>
</ul></td>
</tr>
<tr>
