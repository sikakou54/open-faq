<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-006-001 FAQ 編集**
<!-- /portal-top -->
...
| 関連 | 内容 |
|----|----|
| FR / BR | FR-025〜FR-033, FR-053〜FR-056, FR-057, FR-058 / BR-028 |
...
> [!NOTE]
> **補足** 各ステークホルダとも当該プロジェクトへの割当(FAQ 管理権限)が前提です。割当のないプロジェクトの FAQ は編集不可(URL 直アクセスは権限不足表示)。状態(下書き / 公開中 / 非公開)の切替は独立ボタンを設けず「状態」ラジオの選択 + 「保存」で一元化します(専用の公開 API・状態遷移ガードなし)。`published` を選択して保存する操作が「公開前のメンバー確認」(FR-030)を兼ねます。
...
<td>—</td>
<td>—</td>
<td><code>POST /faqs</code>(<a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a>)</td>
</tr>
<tr>
<td>FAQ 取得</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /faqs/{id}</code>(<a href="../02_api-design/API-faq.md#API-FAQ-009">FAQ 個別取得</a>)</td>
</tr>
<tr>
<td>FAQ 更新</td>
...
<td>◯</td>
<td>—</td>
<td><code>PATCH /faqs/{id}</code>(<a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a>)</td>
</tr>
<tr>
<td>FAQ 削除</td>
<td>FAQ を論理削除する</td>
...
<td>—</td>
<td>◯</td>
<td><code>DELETE /faqs/{id}</code>(<a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a>)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li>既存編集: <a href="../02_api-design/API-faq.md#API-FAQ-009">FAQ 個別取得</a> で現値をロードし各欄へ展開。登録元未解決質問が存在する場合は IT-07 を表示</li>
...
<td><ul>
<li>成功: <a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で現在の入力内容を下書き保存し、IT-02 を「保存済み」に更新</li>
...
<li>新規・成功: <a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で FAQ を新規作成し一覧へ遷移</li>
<li>既存・成功: <a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で FAQ を更新し一覧へ遷移</li>
...
<td><ul>
<li>成功: <a href="../02_api-design/API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で論理削除し一覧へ遷移</li>
...
<td>登録元の未解決質問詳細画面(<a href="SCR-005-001.md">SCR-005-001</a>)へ遷移する</td>
</tr>
<tr>
...
<td>編集内容を破棄して FAQ 一覧(<a href="SCR-006.md">SCR-006</a>)へ遷移する</td>
</tr>
<tr>
