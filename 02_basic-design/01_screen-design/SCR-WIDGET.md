<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **WIDGET エンドユーザー向け FAQ ウィジェット**
<!-- /portal-top -->
...
本ウィジェットが呼び出す公開 API の一覧です。公開 API のベースは `/widget/v1/...`、正本は [API設計(ウィジェット API 群)](../02_api-design/index.md)です(各 API の節は下表の行リンク先を正とします)。ウィジェットはサーバ経由でテーブルへアクセスし、直接の永続更新は行いません。
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/bootstrap</code>(<a href="../02_api-design/index.md#API-WGT-001">API 設計 5.5.1</a>)</td>
</tr>
<tr>
<td>質問送信</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/ask</code>(<a href="../02_api-design/API-widget.md#API-WGT-002">ウィジェット質問送信</a>)</td>
</tr>
<tr>
<td>未解決質問登録</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/inquiries</code>(<a href="../02_api-design/API-widget.md#API-WGT-003">ウィジェット未解決質問登録</a>)</td>
</tr>
</tbody>
</table>
...
<li><a href="../02_api-design/API-widget.md#API-WGT-001">ウィジェット起動</a> API でセッションを確立し、ウィジェット設定(タイトル・連絡先メール等)を取得する</li>
...
<td>「送信」を押下</td>
<td><ul>
<li><a href="../02_api-design/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API で質問を送信し、AI 回答を同じ会話欄に追加表示する</li>
...
<td>AI 回答(未解決)を受信</td>
<td><ul>
<li><a href="../02_api-design/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API のレスポンスが <code>type=unanswered</code> の場合に発生する(EV-05 の結果として続いて処理される)</li>
<li>回答できなかった旨をシステム返信として会話欄に追加表示する</li>
<li><a href="../02_api-design/API-widget.md#API-WGT-003">ウィジェット未解決質問登録</a> API を呼び出し、質問ログと未解決質問を登録する</li>
...
<td>受付制限(429)を受信</td>
<td><ul>
<li><a href="../02_api-design/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API から質問数上限到達または支払方法ゲートによる 429 を受信した場合に発生する(EV-05 の結果として続いて処理される)</li>
...
<td>処理エラーを受信</td>
<td><ul>
<li><a href="../02_api-design/API-widget.md#API-WGT-001">ウィジェット起動</a> または <a href="../02_api-design/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API の処理エラー(通信障害・上流障害・認可エラー等)が発生した場合に発生する</li>
