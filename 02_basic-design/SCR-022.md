...
<td>初期表示(請求サマリ)</td>
<td><ul>
<li><a href="API-billing.md#API-BIL-003">請求サマリ</a> API で請求見込み・次回請求日・請求状態・プロジェクト別内訳を取得し表示</li>
<li>支払い失敗・未登録時: バナー表示(<a href="#IT-09">IT-09</a>)</li>
</ul></td>
</tr>
<tr>
...
<td>—</td>
<td>初期表示(請求履歴)</td>
<td><a href="API-billing.md#API-BIL-004">請求書一覧</a> API で請求月・金額・状態・請求書 PDF を取得し履歴へ表示</td>
</tr>
<tr>
<td><code>EV-03</code></td>
<td><a href="#IT-06">IT-06</a></td>
<td>「支払方法を変更」を押下</td>
<td>課金情報変更につき再認証(現パスワード再入力)を経て <a href="API-billing.md#API-BIL-005">支払方法 取得・登録・更新</a> API で支払方法を登録・更新する</td>
</tr>
<tr>
