...
本画面が読み取るテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](03_database-design.md)、API の正本は [API設計](02_api-design.md#API-BIL-001) です。
...
<td>—</td>
<td>—</td>
<td>取得方式の正本は <a href="02_api-design.md#API-BIL-001">API設計</a>。物理名 <code>GET /usage?period=current_month&amp;viewMode={contract|project}</code></td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li><a href="02_api-design.md#API-BIL-001">利用状況取得</a> API を呼び出し、契約全体サマリー(IT-01)とプロジェクト別利用状況(IT-03)を取得して表示する</li>
