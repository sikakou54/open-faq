...
<td>一括操作バーのボタンを押下</td>
<td>選択中 FAQ を <a href="API-faq.md#API-FAQ-003">FAQ 一括状態変更</a> API で一括公開 / 非公開化、または一括削除(確認ダイアログ)</td>
</tr>
<tr>
...
<td>フィルタ適用結果を <a href="API-faq.md#API-FAQ-006">FAQ CSV エクスポート</a> API で CSV ダウンロード</td>
</tr>
</tbody>
</table>
