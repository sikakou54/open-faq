...
本画面が更新するテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](03_database-design.md)、API の正本は [API設計](02_api-design.md) です。
...
<td>—</td>
<td>—</td>
<td><a href="API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a>(API-AUTH-009)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li>URL パスパラメータのトークンを取得し、<a href="API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a> API (POST /auth/contact-verifications/{token}) を呼び出す</li>
