...
<td>初期表示</td>
<td><ul>
<li><a href="API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a> API でトークンを検証</li>
<li>200: 確認完了画面を表示</li>
<li>410(期限切れ / 既使用): 各エラー画面へ分岐</li>
</ul></td>
</tr>
<tr>
...
<td>「閉じる」を押下</td>
<td>window.close() または静的なランディングメッセージを表示(認証コンソールへの遷移は行わない)</td>
</tr>
</tbody>
</table>
