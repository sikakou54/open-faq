...
本画面が読み書きするテーブル・ファイルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](03_database-design.md)、API の正本は [API設計](02_api-design.md#API-INQ-001) です。
...
<td>状況フィルタを選択</td>
<td><ul>
<li>選択中の状況条件を付与して <a href="API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
...
<td><ul>
<li>現在のフィルタ条件を適用した全件を CSV 形式で生成しダウンロードする</li>
