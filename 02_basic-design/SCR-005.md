...
<td>初期表示</td>
<td><ul>
<li><a href="API-inquiry.md#API-INQ-001">未解決質問一覧</a> API で一覧を取得し表示</li>
...
<td>状況フィルタを変更</td>
<td>条件を付与して <a href="API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得し一覧を更新</td>
</tr>
<tr>
