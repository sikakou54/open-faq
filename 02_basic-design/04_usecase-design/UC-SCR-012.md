<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-012: お知らせ詳細 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-012](../01_screen-design/SCR-012.md#SCR-012) の §6 画面イベント一覧(EV-01〜EV-04)を、ユースケース ID へ 1:1 で対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内のみで完結する「クライアント内処理のみ」に区別します。
...
| 関連 | [SCR-012](../01_screen-design/SCR-012.md#SCR-012) ・ [API-ANN-001](../02_api-design/API-inbox.md#API-ANN-001) ・ [API-ANN-002](../02_api-design/API-inbox.md#API-ANN-002) ・ [FR-117](../../01_requirements/FR15.md#FR-117) ・ [FR-118](../../01_requirements/FR15.md#FR-118) |
...
| 関連 | [SCR-012](../01_screen-design/SCR-012.md#SCR-012) ・ [SCR-011](../01_screen-design/SCR-011.md#SCR-011) |
...
| 関連 | [SCR-012](../01_screen-design/SCR-012.md#SCR-012) |
