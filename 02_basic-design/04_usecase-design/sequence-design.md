<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **ユースケース・シーケンス設計書**
<!-- /portal-top -->
...
> [!NOTE]
> **本書と詳細ユースケースの関係** 本書は複数画面・非同期処理をまたぐ横断フロー(粗粒度の 10 UC)を示します。画面イベント単位(`EV-xx`)に 1:1 対応した詳細ユースケースと、システム起点(バッチ・Webhook・非同期ジョブ)のユースケースは [ユースケース一覧](index.md) を参照してください。
...
<div class="card"><div class="lead-ico">①</div><h4>要件 → 画面</h4><p>要件(FR)がどの画面・アクションに落ちるかは <a href="../index.md#fr">ポータル §3</a> と <a href="../01_screen-design/index.md">画面設計</a> が担う。</p></div>
<div class="card"><div class="lead-ico">②</div><h4>画面 → API → DB</h4><p>画面の各アクションが呼ぶ API と触れるテーブルは <a href="../01_screen-design/index.md#flow">画面設計 §4</a> に集約。</p></div>
...
<td>契約オーナー(新規)</td>
<td><a href="../01_screen-design/index.md#SCR-002" style="font-size:10.5px">SCR-002</a> <a href="../01_screen-design/index.md#SCR-013" style="font-size:10.5px">SCR-013</a></td>
...
<td>全認証ユーザー</td>
<td><a href="../01_screen-design/index.md#SCR-001" style="font-size:10.5px">SCR-001</a></td>
<td style="font-size: 11.5px">FR01 アカウント管理</td>
</tr>
<tr>
...
<td>オーナー</td>
<td><a href="../01_screen-design/index.md#SCR-004" style="font-size:10.5px">SCR-004</a> <a href="../01_screen-design/index.md#SCR-004-001" style="font-size:10.5px">SCR-004-001</a></td>
...
<td><a href="../01_screen-design/index.md#SCR-009-001" style="font-size:10.5px">SCR-009-001</a> <a href="../01_screen-design/index.md#SCR-018" style="font-size:10.5px">SCR-018</a></td>
...
<td>オーナー / メンバー+</td>
<td><a href="../01_screen-design/index.md#SCR-006" style="font-size:10.5px">SCR-006</a> <a href="../01_screen-design/index.md#SCR-006-001" style="font-size:10.5px">SCR-006-001</a></td>
...
<td>オーナー / メンバー+</td>
<td><a href="../01_screen-design/index.md#SCR-006-002" style="font-size:10.5px">SCR-006-002</a></td>
...
<td>エンドユーザー(公開)</td>
<td><a href="../01_screen-design/index.md#WIDGET" style="font-size:10.5px">WIDGET</a></td>
...
<td>オーナー / メンバー+</td>
<td><a href="../01_screen-design/index.md#SCR-005" style="font-size:10.5px">SCR-005</a> <a href="../01_screen-design/index.md#SCR-005-001" style="font-size:10.5px">SCR-005-001</a> <a href="../01_screen-design/index.md#SCR-006-001" style="font-size:10.5px">SCR-006-001</a></td>
...
<td>オーナー</td>
<td><a href="../01_screen-design/index.md#SCR-021" style="font-size:10.5px">SCR-021</a> <a href="../01_screen-design/index.md#SCR-022" style="font-size:10.5px">SCR-022</a></td>
...
<td>オーナー</td>
<td><a href="../01_screen-design/index.md#SCR-023" style="font-size:10.5px">SCR-023</a> <a href="../01_screen-design/index.md#SCR-014" style="font-size:10.5px">SCR-014</a></td>
...
各ユースケースを「アクター → 画面(SCR)→ API → DB」のシーケンスで示します。メッセージ中の `テーブル名(CRUD)` は [データベース設計書](../03_database-design/index.md) のテーブルに対応します。
...
要件群(FR)→ ユースケース → 画面 → 中核 API → 主テーブル の対応一覧です。詳細なアクション単位の対応は [画面設計書 §4](../01_screen-design/index.md#flow) を正本とします。
...
> [!TIP]
> **縦串が一直線に追える** 要件(FR)から DB テーブルまで、各層の設計書を本マトリクスとシーケンス図がつなぎます。逆方向(テーブル → 使用元 API / 画面)は [データベース設計書 §2](../03_database-design/index.md#map) の「使用元」で追跡できます。
