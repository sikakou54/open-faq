<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-003: パスワード再設定 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-003](../01_screen-design/SCR-003.md#SCR-003) §6 の各イベントを、1 対 1 でユースケースへ対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内で完結する「クライアント内処理のみ」を区別します。
...
| 関連 | [SCR-003](../01_screen-design/SCR-003.md#SCR-003) ・ [FR-004](../../01_requirements/FR01.md#FR-004) |
...
| 関連 | [SCR-003](../01_screen-design/SCR-003.md#SCR-003) ・ [API-AUTH-004](../02_api-design/API-auth.md#API-AUTH-004) ・ [FR-004](../../01_requirements/FR01.md#FR-004) |

**基本フロー**
1. 画面が IT-02 の形式バリデーションを実行する。
2. 形式正常時、パスワード再設定要求 API(`POST /auth/password-reset-request` = [API-AUTH-004](../02_api-design/API-auth.md#API-AUTH-004))を発行する。
...
3. 画面はパスワード再設定要求 API([API-AUTH-004](../02_api-design/API-auth.md#API-AUTH-004))を再発行する。
...
| 関連 | [SCR-003](../01_screen-design/SCR-003.md#SCR-003) ・ [API-AUTH-010](../02_api-design/API-auth.md#API-AUTH-010) ・ [FR-004](../../01_requirements/FR01.md#FR-004) |
...
> [!NOTE]
> トークン検証はパスワード再設定確定 API([API-AUTH-010](../02_api-design/API-auth.md#API-AUTH-010))が前提とするトークンの妥当性に準じます。画面側の初期検証はフォーム表示可否の判定であり、最終確定は EV-07 で行います。
...
2. 画面はパスワード再設定要求 API([API-AUTH-004](../02_api-design/API-auth.md#API-AUTH-004))を発行する。
...
| 関連 | [SCR-003](../01_screen-design/SCR-003.md#SCR-003) ・ [FR-006](../../01_requirements/FR01.md#FR-006) |
...
| 関連 | [SCR-003](../01_screen-design/SCR-003.md#SCR-003) ・ [API-AUTH-010](../02_api-design/API-auth.md#API-AUTH-010) ・ [FR-006](../../01_requirements/FR01.md#FR-006) |

**基本フロー**
1. 画面が IT-06 の強度要件(FR-006: 12 文字以上・3 種類以上の文字種)を検証する。
2. 画面が IT-07 の一致を検証する。
3. 検証成功時、パスワード再設定確定 API(`POST /auth/password-reset` = [API-AUTH-010](../02_api-design/API-auth.md#API-AUTH-010))を発行する。
