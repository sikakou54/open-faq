<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-WIDGET: エンドユーザー向け FAQ ウィジェット ユースケース**
<!-- /portal-top -->
...
ウィジェット [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) の §6 画面イベント一覧(EV-01〜EV-08)を、ユースケース ID へ 1:1 で対応づけます。種別は、サーバ公開 API・DB へアクセスする「API/DB 連携」と、ウィジェット内のみで完結する「クライアント内処理のみ」に区別します。EV-06・EV-07・EV-08 は EV-05 の質問送信結果(応答種別)として続いて処理される状態遷移です。
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [FR-034](../../01_requirements/FR05.md#FR-034) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [API-WGT-001](../02_api-design/API-widget.md#API-WGT-001) ・ [FR-034](../../01_requirements/FR05.md#FR-034) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [API-WGT-002](../02_api-design/API-widget.md#API-WGT-002) ・ [FR-038](../../01_requirements/FR05.md#FR-038) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [API-WGT-003](../02_api-design/API-widget.md#API-WGT-003) ・ [FR-045](../../01_requirements/FR06.md#FR-045) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [API-WGT-002](../02_api-design/API-widget.md#API-WGT-002) ・ [FR-073](../../01_requirements/FR09.md#FR-073) |
...
| 関連 | [SCR-WIDGET](../01_screen-design/SCR-WIDGET.md#WIDGET) ・ [API-WGT-001](../02_api-design/API-widget.md#API-WGT-001) ・ [API-WGT-002](../02_api-design/API-widget.md#API-WGT-002) |
