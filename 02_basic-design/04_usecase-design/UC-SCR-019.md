<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-019: プロジェクト連絡先メール確認完了 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-019](../01_screen-design/SCR-019.md#SCR-019) §6 の各イベントを、1 対 1 でユースケースへ対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内で完結する「クライアント内処理のみ」を区別します。
...
| 関連 | [SCR-019](../01_screen-design/SCR-019.md#SCR-019) ・ [API-AUTH-009](../02_api-design/API-auth.md#API-AUTH-009) ・ [FR-022a](../../01_requirements/FR03.md#FR-022a) ・ [FR-022c](../../01_requirements/FR03.md#FR-022c) |

**基本フロー**
1. 画面が URL パスパラメータのトークンを取得する。
2. 画面は連絡先メール確認 API(`POST /auth/contact-verifications/{token}` = [API-AUTH-009](../02_api-design/API-auth.md#API-AUTH-009))を呼び出す。
...
| 関連 | [SCR-019](../01_screen-design/SCR-019.md#SCR-019) ・ [FR-022a](../../01_requirements/FR03.md#FR-022a) |
