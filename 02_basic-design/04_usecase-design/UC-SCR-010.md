<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-010: 利用規約閲覧 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-010](../01_screen-design/SCR-010.md#SCR-010) の §6 画面イベント一覧(EV-01〜EV-03)を、ユースケース ID へ 1:1 で対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内のみで完結する「クライアント内処理のみ」に区別します。
...
| 関連 | [SCR-010](../01_screen-design/SCR-010.md#SCR-010) ・ [API-TRM-001](../02_api-design/API-terms.md#API-TRM-001) ・ [FR-101](../../01_requirements/FR13.md#FR-101) |
...
| 関連 | [SCR-010](../01_screen-design/SCR-010.md#SCR-010) ・ [SCR-015](../01_screen-design/SCR-015.md#SCR-015) |
...
| 関連 | [SCR-010](../01_screen-design/SCR-010.md#SCR-010) ・ [API-TRM-003](../02_api-design/API-terms.md#API-TRM-003) ・ [FR-101](../../01_requirements/FR13.md#FR-101) |
