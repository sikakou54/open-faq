<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SYSTEM-008: 質問数上限アラート通知**
<!-- /portal-top -->
...
| 関連要件 | [FR-071](../../01_requirements/FR09.md#FR-071) 上限アラート通知 ・ [FR-070](../../01_requirements/FR09.md#FR-070) リアルタイム集計 |
| 主テーブル | `M_PRJ_QUOTA_LIMITS(R)` ・ `T_USAGE_METER(R)` ・ `T_INBOX_MSG(C)` ・ `H_NOTIF_LOGS(C)` |
| 関連 API | [API-BIL-006](../02_api-design/API-billing.md#API-BIL-006) プロジェクト上限参照 ・ [API-MAIL-001](../02_api-design/API-mail.md#API-MAIL-001) メール配信 IF |
...
6. 各宛先へ上限アラートメールをメール配信 IF([API-MAIL-001](../02_api-design/API-mail.md#API-MAIL-001))で送信し、`H_NOTIF_LOGS(C)` に配信ログを記録する([FR-071](../../01_requirements/FR09.md#FR-071))。
...
- 選択閾値への当月初回到達時のみ、オーナー + 当該プロジェクトの有効メンバーへアラートが送信される([FR-071](../../01_requirements/FR09.md#FR-071))。
