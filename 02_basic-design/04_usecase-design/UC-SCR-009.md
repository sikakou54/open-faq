<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-009: メンバー(プロジェクト) ユースケース**
<!-- /portal-top -->
...
画面 [SCR-009](../01_screen-design/SCR-009.md#SCR-009) の §6 画面イベント一覧(EV-01〜EV-08)を、ユースケース ID へ 1:1 で対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内のみで完結する「クライアント内処理のみ」に区別します。
...
| 関連 | [SCR-009](../01_screen-design/SCR-009.md#SCR-009) ・ [API-MBR-001](../02_api-design/API-member.md#API-MBR-001) |
...
| 事後条件 | メンバー招待 / 編集モーダル([SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001))を招待モードで開く |
| 関連 | [SCR-009](../01_screen-design/SCR-009.md#SCR-009) ・ [SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001) |

基本フロー

1. 利用者が「+ メンバーを招待」(IT-09)を押下する。
2. 画面はメンバー招待 / 編集モーダル([SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001))を招待モードで開く。
...
| 事後条件 | メンバー招待 / 編集モーダル([SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001))を編集モードで開く |
| 関連 | [SCR-009](../01_screen-design/SCR-009.md#SCR-009) ・ [SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001) |

基本フロー

1. 利用者が利用者表示名(IT-04)のリンクを押下する。
2. 画面は対象メンバーを引き継ぎ、メンバー招待 / 編集モーダル([SCR-009-001](../01_screen-design/SCR-009-001.md#SCR-009-001))を編集モードで開く。
...
| 事後条件 | ダッシュボードへ遷移する |
| 関連 | [SCR-009](../01_screen-design/SCR-009.md#SCR-009) |
