<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [ユースケース設計](index.md) ／ **UC-SCR-007: ウィジェット設定 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-007](../01_screen-design/SCR-007.md#SCR-007) の §6 画面イベント一覧(EV-01〜EV-11)を、ユースケース ID へ 1:1 で対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内のみで完結する「クライアント内処理のみ」に区別します。
...
| 関連 | [SCR-007](../01_screen-design/SCR-007.md#SCR-007) ・ [API-PRJ-003](../02_api-design/API-project.md#API-PRJ-003) ・ [FR-020](../../01_requirements/FR03.md#FR-020) |
...
| 関連 | [SCR-007](../01_screen-design/SCR-007.md#SCR-007) |
...
| 関連 | [SCR-007](../01_screen-design/SCR-007.md#SCR-007) ・ [API-PRJ-004](../02_api-design/API-project.md#API-PRJ-004) |
...
| 関連 | [SCR-007](../01_screen-design/SCR-007.md#SCR-007) ・ [API-PRJ-003](../02_api-design/API-project.md#API-PRJ-003) |
...
| 事前条件 | ウィジェット設定画面を表示している |
| トリガー | 「概要」を押下する |
| 事後条件 | 概要(プロジェクト)([SCR-008](../01_screen-design/SCR-008.md#SCR-008))へ遷移する |
| 関連 | [SCR-007](../01_screen-design/SCR-007.md#SCR-007) ・ [SCR-008](../01_screen-design/SCR-008.md#SCR-008) |

基本フロー

1. 利用者が「概要」を押下する。
2. 画面は概要(プロジェクト)([SCR-008](../01_screen-design/SCR-008.md#SCR-008))へ遷移する。
