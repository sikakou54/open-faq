...
<td>初期表示</td>
<td><ul>
<li><a href="API-dashboard.md#API-DASH-001">ダッシュボードサマリ</a> API で質問数・未解決数・公開 FAQ 件数を取得し KPI カードへ表示</li>
<li>suspended 時: アラート表示(<a href="#IT-04">IT-04</a>)</li>
</ul></td>
</tr>
<tr>
...
<td>期間を変更</td>
<td>選択期間で <a href="API-dashboard.md#API-DASH-001">ダッシュボードサマリ</a> API を再取得し KPI を更新</td>
</tr>
<tr>
<td><code>EV-03</code></td>
<td><a href="#IT-05">IT-05</a></td>
<td>質問数カードを押下</td>
<td>SCR-005 へ遷移(status 絞り込みなし)</td>
</tr>
<tr>
<td><code>EV-04</code></td>
<td><a href="#IT-06">IT-06</a></td>
<td>未解決数カードを押下</td>
<td>SCR-005 へ遷移(status=open)</td>
</tr>
<tr>
