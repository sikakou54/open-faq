...
本画面が読み取るテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](03_database-design.md)、API の正本は [API設計a](02_api-design.md) です。
...
<td>初期表示</td>
<td><ul>
<li><a href="API-terms.md#API-TRM-002">プライバシーポリシー 最新版取得</a> API で最新版全文を取得し <a href="#IT-02">IT-02</a> に表示</li>
<li>ログイン済みの場合: 同意状態バッジ(<a href="#IT-01">IT-01</a>)を取得・表示する。同意済みは緑バッジ(同意日付き)、未同意は赤バッジ(SCR-015 へのリンク付き)で表示</li>
...
<td>SCR-015 規約再同意へ遷移する</td>
</tr>
<tr>
<td><code>EV-03</code></td>
<td>—</td>
<td>「利用規約」を押下</td>
<td>SCR-010 利用規約閲覧へ遷移する</td>
</tr>
</tbody>
</table>
