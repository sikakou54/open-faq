...
本画面が読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](03_database-design.md)、API の正本は [API設計](02_api-design.md#API-FAQ-002) です。
...
<td>初期表示</td>
<td><ul>
<li>既存編集: <a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で現値をロードし各欄へ展開。登録元未解決質問が存在する場合は IT-07 を表示</li>
...
<li>未保存変更あり: 確認ダイアログを表示し、OK 押下で破棄して一覧へ遷移</li>
</ul></td>
</tr>
<tr>
