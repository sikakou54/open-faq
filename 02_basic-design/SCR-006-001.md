...
<td>—</td>
<td>—</td>
<td><code>POST /faqs</code>(<a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a>)</td>
</tr>
<tr>
<td>FAQ 取得</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /faqs/{id}</code>(<a href="API-faq.md#API-FAQ-009">FAQ 個別取得</a>)</td>
</tr>
<tr>
<td>FAQ 更新</td>
...
<td>◯</td>
<td>—</td>
<td><code>PATCH /faqs/{id}</code>(<a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a>)</td>
</tr>
<tr>
<td>FAQ 削除</td>
<td>FAQ を論理削除する</td>
...
<td>初期表示</td>
<td><ul>
<li>既存編集: <a href="API-faq.md#API-FAQ-009">FAQ 個別取得</a> で現値をロードし各欄へ展開。登録元未解決質問が存在する場合は IT-07 を表示</li>
...
<td><ul>
<li>成功: <a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で現在の入力内容を下書き保存し、IT-02 を「保存済み」に更新</li>
...
<li>新規・成功: <a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で FAQ を新規作成し一覧へ遷移</li>
<li>既存・成功: <a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で FAQ を更新し一覧へ遷移</li>
...
<td><ul>
<li>成功: <a href="API-faq.md#API-FAQ-002">FAQ 作成・更新・削除</a> で論理削除し一覧へ遷移</li>
