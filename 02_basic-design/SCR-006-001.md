...
<td>初期表示</td>
<td><ul>
<li>既存編集: <code>GET /faqs/{id}</code> で現値をロードし各欄へ展開</li>
<li>新規: 空フォーム</li>
</ul></td>
</tr>
<tr>
...
<li><code>M_FAQS.version</code> 不一致時: 楽観ロックエラー(<a href="#IT-12">IT-12</a>)</li>
</ul></td>
</tr>
<tr>
...
<td>「削除」を押下</td>
<td>確認ダイアログ後 <code>DELETE /faqs/{id}</code> で論理削除し一覧へ戻る</td>
</tr>
<tr>
