...
<td>
<ul>
<li><a href="API-inbox.md#API-ANN-001">お知らせ一覧</a> API でお知らせ本文・メタ情報(種別・重要度・配信日時・既読日時)を取得し表示する</li>
...
<td>
<ul>
<li>一覧の並び順に基づき、前または次のお知らせの SCR-012 へ遷移する</li>
<li>先頭のお知らせでは「前のお知らせ」リンクを非活性にする</li>
<li>末尾のお知らせでは「次のお知らせ」リンクを非活性にする</li>
</ul>
</td>
</tr>
</tbody>
