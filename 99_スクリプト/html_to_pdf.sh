...
#   ./html_to_pdf.sh 画面遷移図.html
#   ./html_to_pdf.sh 画面遷移図.html design.html
#
# 出力先を指定:
#   ./html_to_pdf.sh --out ./PDF出力 画面遷移図.html
#
# エンジンを明示指定:
#   ./html_to_pdf.sh --engine chrome 画面遷移図.html
#   ./html_to_pdf.sh --engine weasyprint 画面遷移図.html
...
Examples:
  $0 画面遷移図.html                          # カレントディレクトリに 画面遷移図.pdf を出力
  $0 --out ./dist 画面遷移図.html design.html
  $0 --engine weasyprint 画面遷移図.html
