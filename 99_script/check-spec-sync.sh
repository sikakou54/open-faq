...
require_pattern "owners" "01_メインシステム/02_基本設計/03_テーブル設計/index.html"
require_pattern "project_users" "01_メインシステム/02_基本設計/03_テーブル設計/index.html"
require_pattern "project_user_assignments" "01_メインシステム/02_基本設計/03_テーブル設計/index.html"
...
for v in "active" "suspended" "deleted_pending" "deleted"; do
  ...
  require_pattern ">${v}<|'${v}'" "01_メインシステム/02_基本設計/03_テーブル設計/owners.html"
done
