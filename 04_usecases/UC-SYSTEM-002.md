<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-002: Resend Webhook 受信(配信状態更新)**
<!-- /portal-top -->
...
| 関連 API | [API-WHK-001](../02_basic-design/API-webhook.md#API-WHK-001)(受信) |
...
Webhook 受信。Resend が [API-WHK-001](../02_basic-design/API-webhook.md#API-WHK-001)(`POST /webhooks/resend`)へ配信イベントを送信したことを契機に起動する。

## 5. 基本フロー

1. Resend が配信イベント Webhook を [API-WHK-001](../02_basic-design/API-webhook.md#API-WHK-001) へ送信する。
