<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SCR-018: メンバーアカウント有効化 ユースケース**
<!-- /portal-top -->
...
画面 [SCR-018](../02_basic-design/SCR-018.md#SCR-018) §6 の各イベントを、1 対 1 でユースケースへ対応づけます。種別は、サーバ API・DB へアクセスする「API/DB 連携」と、画面内で完結する「クライアント内処理のみ」を区別します。
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [API-AUTH-007](../02_basic-design/API-auth.md#API-AUTH-007) ・ [FR-013](../01_requirements/FR02.md#FR-013) |

**基本フロー**
1. 画面が招待トークン検証・プレビュー API(`POST /auth/invitations/{token}/preview` = [API-AUTH-007](../02_basic-design/API-auth.md#API-AUTH-007))を実行する。
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [FR-013d](../01_requirements/FR02.md#FR-013d) |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [FR-006](../01_requirements/FR01.md#FR-006) |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [FR-099](../01_requirements/FR13.md#FR-099) |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ SCR-010 利用規約閲覧 |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ SCR-020 プライバシーポリシー閲覧 |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [FR-111](../01_requirements/FR14.md#FR-111) |
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [API-AUTH-008](../02_basic-design/API-auth.md#API-AUTH-008) ・ [FR-013](../01_requirements/FR02.md#FR-013) ・ [FR-099](../01_requirements/FR13.md#FR-099) |

**基本フロー**
1. 全項目のクライアント側バリデーション(EV-02〜EV-09 の各検証)を実行し、エラーがある場合は送信せずエラーを表示する。
2. バリデーション通過後、メンバーアカウント有効化 API(`POST /auth/invitations/{token}/activate` = [API-AUTH-008](../02_basic-design/API-auth.md#API-AUTH-008))を実行する。
...
| 関連 | [SCR-018](../02_basic-design/SCR-018.md#SCR-018) ・ [SCR-001](../02_basic-design/SCR-001.md#SCR-001) |
