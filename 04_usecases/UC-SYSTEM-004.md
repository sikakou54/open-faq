<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-004: 月次請求確定バッチ**
<!-- /portal-top -->
...
| 関連 API | [API-BIL-003](../02_basic-design/API-billing.md#API-BIL-003) 請求サマリ(確定結果の参照) ・ [API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001) メール配信 IF |
...
6. バッチが当該契約のオーナーへ月次請求確定通知をメール配信 IF([API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001))で送信し、`H_NOTIF_LOGS(C)` に配信ログを記録する。
