<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SCR-001: ログイン ユースケース**
<!-- /portal-top -->
...
画面 [SCR-001](../02_basic-design/SCR-001.md#SCR-001) §6 の各イベントを、1 対 1 でユースケースへ対応づけます。種別は API/DB 連携を伴うか、画面内で完結するかを区別します。
...
| 関連 | [SCR-001](../02_basic-design/SCR-001.md#SCR-001) ・ [API-AUTH-002](../02_basic-design/API-auth.md#API-AUTH-002) ・ [FR-004](../01_requirements/FR01.md#FR-004) |
...
| 関連 | [SCR-001](../02_basic-design/SCR-001.md#SCR-001) ・ [FR-004](../01_requirements/FR01.md#FR-004) |
...
| 関連 | [SCR-001](../02_basic-design/SCR-001.md#SCR-001) ・ [API-AUTH-002](../02_basic-design/API-auth.md#API-AUTH-002) ・ [FR-004](../01_requirements/FR01.md#FR-004) ・ [FR-007](../01_requirements/FR01.md#FR-007) |

**基本フロー**
1. IT-01・IT-02 の必須・形式を再検証し、不正なら送信を中止してエラーを表示する。
2. 連続失敗後で Turnstile が要求される場合は IT-08 を提示し、取得したトークンを送信内容に含める。
3. ログイン API(`POST /auth/login` = [API-AUTH-002](../02_basic-design/API-auth.md#API-AUTH-002))を呼び出す。資格情報を `M_CONTRACT` / `M_PRJ_USERS`(両マスタは分離)で照合し、ロック状態・契約停止状態を判定する。
