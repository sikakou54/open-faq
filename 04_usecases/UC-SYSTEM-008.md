<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-008: 質問数上限アラート通知**
<!-- /portal-top -->
...
| 関連 API | [API-BIL-006](../02_basic-design/API-billing.md#API-BIL-006) プロジェクト上限参照 ・ [API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001) メール配信 IF |
...
6. 各宛先へ上限アラートメールをメール配信 IF([API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001))で送信し、`H_NOTIF_LOGS(C)` に配信ログを記録する([FR-071](../01_requirements/FR09.md#FR-071))。
