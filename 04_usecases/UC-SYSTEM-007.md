<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-007: メンバー割当変更通知**
<!-- /portal-top -->
...
| 関連 API | [API-MBR-001](../02_basic-design/API-member.md#API-MBR-001) メンバー管理(契機操作) ・ [API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001) メール配信 IF |
...
4. 対象メンバーへ割当変更通知メールをメール配信 IF([API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001))で送信する。
