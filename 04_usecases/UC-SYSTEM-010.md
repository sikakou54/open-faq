<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-010: 利用量リアルタイム集計・UI 反映**
<!-- /portal-top -->
...
| 関連 API | [API-BIL-001](../02_basic-design/API-billing.md#API-BIL-001) 利用量参照 ・ [API-DASH-001](../02_basic-design/API-dashboard.md#API-DASH-001) ダッシュボードサマリ |
...
5. 集計結果を管理画面向け利用量サマリへ 5 分以内の遅延で反映する([FR-070](../01_requirements/FR09.md#FR-070))。利用量画面([API-BIL-001](../02_basic-design/API-billing.md#API-BIL-001))・ダッシュボード([API-DASH-001](../02_basic-design/API-dashboard.md#API-DASH-001))で確認できる。
