<!-- portal-top -->
[設計ポータル](../README.md) ／ [ユースケース](index.md) ／ **UC-SYSTEM-009: 通知再送**
<!-- /portal-top -->
...
| 関連 API | [API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001) メール配信 IF ・ [API-DASH-001](../02_basic-design/API-dashboard.md#API-DASH-001) ダッシュボードサマリ(配信失敗の可視化) |
...
4. 条件を満たす対象をメール配信 IF([API-MAIL-001](../02_basic-design/API-mail.md#API-MAIL-001))で再送する。
...
- 配信失敗状況はダッシュボードサマリ([API-DASH-001](../02_basic-design/API-dashboard.md#API-DASH-001))で可視化できる。
