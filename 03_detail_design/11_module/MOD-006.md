...
| M-11 | `app/api/faqs/import/[jobId]/route.ts` | api | 取込ジョブ状態取得要求を受理しプロジェクト所属検証を経て Service へ委譲する([API-067](../../02_basic_design/02_backend/03_apis/API-067.md#API-067)) | HTTP リクエスト | Service 呼び出し・HTTP レスポンス |
