...
| M-06 InquiryService | M-10 FAQ 化履歴リポジトリ | 未解決質問から FAQ への移行履歴照会 | 同期 | 参照系のみ(書き込みは [API-026](../../02_basic_design/02_backend/03_apis/API-026.md#API-026) が担う。§6 参照) |
...
| FAQ 作成モジュール([API-026](../../02_basic_design/02_backend/03_apis/API-026.md#API-026)) | M-10 FAQ 化履歴リポジトリ | 未解決質問から FAQ への移行時の履歴記録 | 同期 | 書き込み主体は [API-026](../../02_basic_design/02_backend/03_apis/API-026.md#API-026) P-06 で確定済み。FAQ 作成トランザクション内で `H_INQUIRY_FAQ`([TBL-029](../../02_basic_design/02_backend/04_database/TBL-029.md#TBL-029))へ記録する([TBL-006](../../02_basic_design/02_backend/04_database/TBL-006.md#TBL-006) `source_inquiry_id` と整合) |
