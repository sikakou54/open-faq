...
- 猶予起点は課金サブスクリプション([TBL-018](../../02_basic_design/02_backend/04_database/TBL-018.md#TBL-018) `grace_started_at`)で保持することが基本設計で確定済み([IPO-003](../04_ipo/IPO-003.md#IPO-003) §5)。物理設計は [DBP-011](../07_db_physical/DBP-011.md#DBP-011) を正本とし、M-13/M-18 の入出力契約はこの確定に整合させる。
