...
| 関連 API | [API-038](../../02_basic_design/02_backend/03_apis/API-038.md#API-038) ・ [API-039](../../02_basic_design/02_backend/03_apis/API-039.md#API-039) ・ [API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068) ・ [API-057](../../02_basic_design/02_backend/03_apis/API-057.md#API-057) |
...
| FeedbackRouteHandler | Route Handler(Controller 相当) | 回答フィードバック要求を受理し Service へ委譲する | `post` | `app/api/widget/v1/feedback/route.ts` 相当([API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068)) |
