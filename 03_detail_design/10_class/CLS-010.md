...
- クラスのモジュール配置(`app/api/billing/**`・`app/api/webhooks/billing`・`lib/service`・`lib/gateway`・`lib/repository`)と依存境界は [MOD-001](../11_module/MOD-001.md#MOD-001) 相当の課金ドメイン版モジュール設計で確定する。
