...
| 関連 API | [API-028](../../02_basic_design/02_backend/03_apis/API-028.md#API-028) ・ [API-029](../../02_basic_design/02_backend/03_apis/API-029.md#API-029) ・ [API-030](../../02_basic_design/02_backend/03_apis/API-030.md#API-030) ・ [API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068) |
...
| 区分 | 対象 |
|----|----|
| 対象機能 | CSV インポート受付([API-028](../../02_basic_design/02_backend/03_apis/API-028.md#API-028))・インポートテンプレート取得([API-029](../../02_basic_design/02_backend/03_apis/API-029.md#API-029))・CSV エクスポート([API-030](../../02_basic_design/02_backend/03_apis/API-030.md#API-030))・取込ジョブ状態取得([API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068))・CSV インポートモーダル([SCR-010](../../02_basic_design/01_frontend/01_screens/SCR-010.md#SCR-010)) |
...
| ImportJobStatusRouteHandler | Route Handler(Controller 相当) | 取込ジョブ状態取得要求を受理し、対象ジョブのプロジェクト所属検証を経て状態・進捗・失敗明細の応答を返す | `get` | `app/api/faqs/import/[jobId]/route.ts` 相当([API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068)) |
...
| ImportJobStatusResponseDto | DTO | ジョブ ID・状態・総行数・処理済み/成功/失敗行数・失敗明細配列 | 取込ジョブ状態取得 API 境界の出力([API-068](../../02_basic_design/02_backend/03_apis/API-068.md#API-068)) |
...
- 本機能領域(CSV インポート/エクスポート/テンプレート/ジョブ状態照会)のモジュール配置(`app/api/faqs/import/**`・`app/api/faqs/export/**`・`lib/service`・`lib/repository`・`lib/gateway`)と依存境界を定義する MOD は未起票のため、起票時に本 CLS と相互リンクする。
