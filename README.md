...
- 読み順: 要件定義 ＞ 業務ユースケース ＞ 画面設計 ＞ 画面イベント ＞ システム設計 ＞ システムイベント ＞ API設計 ＞ DB設計 ＞ シーケンス ＞ 権限 / エラー / メッセージ。
...
| 基本設計 | [02_basic_design/index.md](02_basic_design/index.md) | 画面 SCR / 画面イベント EVT / システム SYS / システムイベント SEV / API / テーブル TBL / シーケンス SEQ / 権限 PERM / エラー ERR / メッセージ MSG / 課金 |
