...
- PII 誤検出報告(FR-064)は SCR-098(PII 誤検出報告管理)に集約され、運営者は AC-036 のとおり **3 営業日以内** に判定する。
...
- [../02_基本設計/01_画面設計.md](../02_基本設計/01_画面設計.md) §SCR-092(AI 推論パラメータ設定)/ SCR-098(PII 誤検出報告管理)
