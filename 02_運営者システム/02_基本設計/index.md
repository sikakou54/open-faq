...
| SCR-093 | レート制限・予算上書き | §5.SCR-093 | `PATCH /v1/operator/rate-limits` ほか | `rate_limit_overrides`, `budget_limit_overrides` | 4-eyes 承認ログ | E-OP-OVERRIDE-* | MSG-SCR-093-* | §6 4-eyes 承認 | §7 監査 | §3 契約上書き |
...
| 6 | 契約別予算上限上書き | 承認ログ | SCR-093 | `budget.override` | 5y(billing)| `PATCH /v1/operator/budgets` |
