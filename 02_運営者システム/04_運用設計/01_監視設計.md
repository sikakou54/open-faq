...
| **SCR-HOME / SCR-096 ダッシュボード集計遅延**(運営者画面 FR-135d / FR-135g 相当) | 本書 | 集計バッチ最終実行時刻が 5 分以上前で normal、15 分以上で high | 運営者 inbox(SCR-HOME 上の集計遅延バナーと連動) | `GET /admin/v1/home` の `meta.last_aggregated_at` |
