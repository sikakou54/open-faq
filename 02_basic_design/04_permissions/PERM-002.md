...
|----|----|----|----|
| PERM-002 | [UC-067](../../01_requirements/04_business_usecases/UC-067.md#UC-067) | — | — |
*種別 権限定義 ・ ステータス ドラフト*
...
| \# | 判定段 | 業務的な条件 | 拒否時のエラー |
|----|----|----|----|
| 1 | セッション検証 | [システム仕様書 §3](../07_system-spec.md#3-タイムアウトセッション認証) のセッション有効条件を満たすこと | [ERR-033](../05_errors/ERR-033.md#ERR-033)（認証切れ） |
...
| 10 | 再認証判定 | 重要操作で [システム仕様書 §3](../07_system-spec.md#3-タイムアウトセッション認証) の再認証有効条件を満たすか | [ERR-013](../05_errors/ERR-013.md#ERR-013)（再認証要求） |
