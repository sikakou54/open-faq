<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **M_OWNER_QUOTA_OVR(契約別レート上書き)**
<!-- /portal-top -->
...
| 対応業務UC(逆引き) | — (横断・レート制御基盤の運用設定。特定業務UCに紐付かない) ・ [UC-076](../../../01_requirements/04_business_usecases/UC-076.md#UC-076) |
