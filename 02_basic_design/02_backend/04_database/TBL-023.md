<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **T_WITHDRAW_REQ(退会申請)**
<!-- /portal-top -->
...
| 監査項目(日時) | — |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-023](../../../01_requirements/04_business_usecases/UC-023.md#UC-023) ・ [UC-071](../../../01_requirements/04_business_usecases/UC-071.md#UC-071) |
...
**画面** [SCR-019](../../01_frontend/01_screens/SCR-019.md) **API** [API-056](../03_apis/index.md#API-056)
