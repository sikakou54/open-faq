...
本テーブルを利用する業務スレッド(TR-ID): [TR-023](../../00_traceability/index.md#TR-023) ・ [TR-086](../../00_traceability/index.md#TR-086)。詳細は [トレーサビリティ一覧](../../00_traceability/index.md#matrix-main) のデータベース列を参照。
