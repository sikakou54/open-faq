...
本テーブルを利用する業務スレッド(TR-ID): [TR-049](../../00_traceability/index.md#TR-049) ・ [TR-075](../../00_traceability/index.md#TR-075)。詳細は [トレーサビリティ一覧](../../00_traceability/index.md#matrix-main) のデータベース列を参照。
