<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **M_ANNOUNCE_AUD(お知らせ配信対象(M:N))**
<!-- /portal-top -->
...
| 監査項目(日時) | `created_at` |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-045](../../../01_requirements/04_business_usecases/UC-045.md#UC-045) ・ [UC-047](../../../01_requirements/04_business_usecases/UC-047.md#UC-047) ・ [UC-046](../../../01_requirements/04_business_usecases/UC-046.md#UC-046) ・ [UC-064](../../../01_requirements/04_business_usecases/UC-064.md#UC-064) |
