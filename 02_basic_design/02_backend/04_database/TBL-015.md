<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **T_PRJ_LEGACY_KEYS(レガシー API キー)**
<!-- /portal-top -->
...
| 監査項目(日時) | `created_at` |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-040](../../../01_requirements/04_business_usecases/UC-040.md#UC-040) ・ [UC-041](../../../01_requirements/04_business_usecases/UC-041.md#UC-041) |
...
**画面** [SCR-011](../../01_frontend/01_screens/SCR-011.md) **API** —
