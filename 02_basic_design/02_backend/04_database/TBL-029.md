...
本テーブルを利用する業務スレッド(TR-ID): [TR-053](../../00_traceability/index.md#TR-053) ・ [TR-054](../../00_traceability/index.md#TR-054)。詳細は [トレーサビリティ一覧](../../00_traceability/index.md#matrix-main) のデータベース列を参照。
