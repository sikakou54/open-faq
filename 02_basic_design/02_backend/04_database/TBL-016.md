<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **T_QLOG_FAQ_REFS(参照 FAQ(M:N))**
<!-- /portal-top -->
...
| 監査項目(日時) | `created_at` |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-031](../../../01_requirements/04_business_usecases/UC-031.md#UC-031) ・ [UC-053](../../../01_requirements/04_business_usecases/UC-053.md#UC-053) |
