...
本テーブルを利用する業務スレッド(TR-ID): [TR-024](../../00_traceability/index.md#TR-024) ・ [TR-082](../../00_traceability/index.md#TR-082)。詳細は [トレーサビリティ一覧](../../00_traceability/index.md#matrix-main) のデータベース列を参照。
