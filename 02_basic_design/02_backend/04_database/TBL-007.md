<!-- portal-top -->
[設計ポータル](../../../README.md) ／ [基本設計](../../index.md) ／ [バックエンド設計](../index.md) ／ [DB設計](index.md) ／ **M_EMAIL_SUPPRESS(メールサプレスリスト)**
<!-- /portal-top -->
...
| 監査項目(日時) | `created_at` |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-063](../../../01_requirements/04_business_usecases/UC-063.md#UC-063) ・ [UC-070](../../../01_requirements/04_business_usecases/UC-070.md#UC-070) |
