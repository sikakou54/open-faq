...
| <span id="API-029"></span>[`API-029`](API-029.md#API-029) | **FAQ インポートテンプレート** GET `/faqs/import/template` | オーナー / 当該プロジェクトのメンバー | — |
...
3. 個別ページの「項目」表で対応画面・対応UC をたどり、画面設計 / ユースケース設計と縦串で確認する。
4. §2 の対応表で API ↔ UC / TBL の結線を俯瞰する。
