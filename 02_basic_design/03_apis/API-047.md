...
|----|----|----|
| 422 | (未サポート項目) → [ERR-031](../07_errors/ERR-031.md#ERR-031) | `freeQuota` / `alertEnabled` / `alertFrequency` を指定 |
| 403 | `E-AUTHZ-FORBIDDEN` → [ERR-032](../07_errors/ERR-032.md#ERR-032) | 当該プロジェクトに割当のないユーザー |
## 利用テーブル
