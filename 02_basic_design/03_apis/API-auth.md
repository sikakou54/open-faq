<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [API設計](index.md) ／ **認証 API**
<!-- /portal-top -->
...
> - API-AUTH-012 自己プロフィール更新
> - API-AUTH-013 自己パスワード変更
> - API-AUTH-014 契約設定取得
> - API-AUTH-015 契約設定更新
...
## <span id="API-AUTH-012"></span>API-AUTH-012 自己プロフィール更新
...
| `reauthToken`  | string | 再認証トークン(メールアドレス変更時必須・API-AUTH-005 で取得) |
...
## <span id="API-AUTH-013"></span>API-AUTH-013 自己パスワード変更
...
| 項目              | 型     | 説明                                                                         |
|-------------------|--------|------------------------------------------------------------------------------|
| `reauthToken`     | string | 再認証トークン(必須・API-AUTH-005 で取得)                                    |
...
## <span id="API-AUTH-014"></span>API-AUTH-014 契約設定取得
...
## <span id="API-AUTH-015"></span>API-AUTH-015 契約設定更新
...
| HTTP ステータス | エラーコード                   | 内容                           |
|-----------------|--------------------------------|--------------------------------|
| 400             | `VALIDATION_ERROR`(E-INPUT-\*) | メールアドレス形式 / タイムゾーン識別子不正 |
| 403             | `E-AUTHZ-OWNER-ONLY`           | オーナー以外は不可             |
