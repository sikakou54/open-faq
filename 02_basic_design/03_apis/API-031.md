<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [API設計](index.md) ／ **API-031: FAQ 全文検索**
<!-- /portal-top -->
...
| API ID | `API-031` |
| API名 | FAQ 全文検索 |
| 対応業務UC | [UC-281](../../01_requirements/02_business_usecases/UC-281.md#UC-281) |
| 対応画面ID | — |
| 対応画面イベントID | — |
...
再構成 P4 で旧 API ID `API-031`(旧グループ別 API 設計)から導出・フラット採番。
