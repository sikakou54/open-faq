...
| 業務要件 (BR) | [BR-059](../../01_requirements/01_BusinessRequirement/03_usage-br.md#BR-059) ・ [BR-077](../../01_requirements/01_BusinessRequirement/05_notification-br.md#BR-077) ・ [BR-111](../../01_requirements/01_BusinessRequirement/05_notification-br.md#BR-111) |
...
sequenceDiagram
  ...
  actor O as オーナー
  SCH->>B: 月初起動(対象月)
  B->>B: 利用量をプロジェクト単位で月次集計(課金対象外を除外)
  B->>B: 無料枠・超過単価を参照し超過分を算定
