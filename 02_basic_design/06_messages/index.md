...
| <span id="MSG-007"></span>[MSG-007](MSG-007.md#MSG-007) | `TPL-BILLING_INVOICE_ISSUED` | NOTIF-BILLING_INVOICE_ISSUED | high | オーナー | ◯ | [システム仕様書 §4](../07_system-spec.md#4-データ保持期間削除猶予)(PDF 再 DL) |
