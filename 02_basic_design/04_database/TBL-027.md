<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [DB設計](index.md) ／ **H_AUDIT_LOGS(監査ログ)**
<!-- /portal-top -->
...
| 監査項目(日時) | `created_at` |
| 監査項目(実施者) | `actor_id` |
| 対応業務UC(逆引き) | [UC-231](../../01_requirements/02_business_usecases/UC-231.md#UC-231) ・ [UC-232](../../01_requirements/02_business_usecases/UC-232.md#UC-232) ・ [UC-247](../../01_requirements/02_business_usecases/UC-247.md#UC-247) |
