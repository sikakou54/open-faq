<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [DB設計](index.md) ／ **TP_FAQ_FTS(FAQ 全文検索)**
<!-- /portal-top -->
...
| 監査項目(日時) | — |
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-063](../../01_requirements/02_business_usecases/UC-063.md#UC-063) ・ [UC-069](../../01_requirements/02_business_usecases/UC-069.md#UC-069) ・ [UC-070](../../01_requirements/02_business_usecases/UC-070.md#UC-070) ・ [UC-071](../../01_requirements/02_business_usecases/UC-071.md#UC-071) ・ [UC-082](../../01_requirements/02_business_usecases/UC-082.md#UC-082) ・ [UC-230](../../01_requirements/02_business_usecases/UC-230.md#UC-230) |
| 利用API(逆引き) | [API-031](../03_apis/API-031.md#API-031) |
<!-- /p5-item -->
