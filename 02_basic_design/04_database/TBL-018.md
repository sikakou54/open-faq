<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [DB設計](index.md) ／ **T_BILL_SUBS(課金サブスクリプション)**
<!-- /portal-top -->
...
| 監査項目(実施者) | — |
| 対応業務UC(逆引き) | [UC-170](../../01_requirements/02_business_usecases/UC-170.md#UC-170) ・ [UC-208](../../01_requirements/02_business_usecases/UC-208.md#UC-208) ・ [UC-209](../../01_requirements/02_business_usecases/UC-209.md#UC-209) ・ [UC-213](../../01_requirements/02_business_usecases/UC-213.md#UC-213) ・ [UC-241](../../01_requirements/02_business_usecases/UC-241.md#UC-241) |
| 利用API(逆引き) | [API-043](../03_apis/API-043.md#API-043) ・ [API-045](../03_apis/API-045.md#API-045) |
<!-- /p5-item -->
