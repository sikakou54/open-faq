...
| 対応業務UC | [UC-001](../../../01_requirements/04_business_usecases/UC-001.md#UC-001) ・ [UC-004](../../../01_requirements/04_business_usecases/UC-004.md#UC-004) ・ [UC-002](../../../01_requirements/04_business_usecases/UC-002.md#UC-002) |
...
本画面が読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../../02_backend/04_database/index.md)、API の正本は [API設計](../../02_backend/03_apis/index.md#API-002) です。
...
<td>—</td>
<td>—</td>
<td><code>POST /auth/login</code>(<a href="../../02_backend/03_apis/API-002.md#API-002">ログイン</a>)</td>
</tr>
<tr>
...
<td>—</td>
<td>—</td>
<td>セッション発行(<a href="../../02_backend/04_database/index.md">データベース設計</a>)</td>
</tr>
</tbody>
</table>
...
<li><a href="../../02_backend/03_apis/API-002.md#API-002">ログイン</a> API(POST /auth/login)を呼び出す</li>
...
<li>失敗(連続失敗 5 回以上): ロックアウト警告(<a href="#IT-07">IT-07</a>)を表示し、15 分間の試行を抑止する(<a href="../../../01_requirements/02_functional_requirement/01_account-fr.md#FR-007">FR-007</a>)</li>
</ul></td>
</tr>
<tr>
