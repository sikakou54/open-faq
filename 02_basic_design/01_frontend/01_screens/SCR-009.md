...
<td><ul>
<li>成功: <a href="../../02_backend/03_apis/API-026.md#API-026">FAQ 作成・更新・削除</a> で現在の入力内容を下書き保存し、IT-02 を「保存済み」に更新</li>
