# <span id="ERR-035"></span>ERR-035: SESSION_EXPIRED
...
認可ミドルウェアのセッション検証段（[PERM-002](../04_permissions/PERM-002.md#PERM-002) 段1）が全認証保護 API 共通で返す。特定 API / EVT には紐づかない横断エラー。
