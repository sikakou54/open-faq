...
本画面が読み取るテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、API の正本は [API設計](../03_apis/index.md#API-BIL-001) です。
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-billing.md#API-BIL-001">利用量サマリ(プロジェクト)</a></td>
</tr>
<tr>
<td>利用状況取得(契約全体)</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-billing.md#API-BIL-002">利用量サマリ(契約)</a></td>
</tr>
</tbody>
</table>
