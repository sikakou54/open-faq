...
<td>◯</td>
<td>◯</td>
<td>論理削除は <code>valid=0</code>。<code>M_PROJECTS</code>(<a href="../04_database/index.md#TBL-M-004">テーブル設計 3.6</a>)</td>
</tr>
<tr>
<td>許可ドメイン</td>
...
<td>◯</td>
<td>◯</td>
<td><code>M_ALLOWED_DOMAINS</code>(<a href="../04_database/index.md#TBL-M-005">テーブル設計 3.8</a>)</td>
</tr>
<tr>
<td>プロジェクト割当</td>
...
<td>◯</td>
<td>—</td>
<td>削除時 <code>valid=0</code>。<code>M_PRJ_USERS</code>(<a href="../04_database/index.md#TBL-M-003">テーブル設計 3.3</a>)</td>
</tr>
<tr>
<td>プロジェクト作成</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-project.md#API-PRJ-002">プロジェクト新規作成</a></td>
</tr>
<tr>
<td>プロジェクト更新・削除</td>
...
<td>◯</td>
<td>◯</td>
<td>編集 <code>PATCH /projects/{id}</code> / 削除 <code>DELETE /projects/{id}</code> / 現値ロード <code>GET /projects/{id}</code>(<a href="../03_apis/API-project.md#API-PRJ-003">プロジェクト更新・削除</a>)</td>
</tr>
<tr>
<td>連絡先メール確認</td>
...
<td>◯</td>
<td>—</td>
<td><a href="../03_apis/API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a></td>
</tr>
<tr>
<td>連絡先確認メール再送</td>
...
<td>◯</td>
<td>—</td>
<td><a href="../03_apis/API-auth.md#API-AUTH-011">連絡先確認メール再送</a></td>
</tr>
</tbody>
</table>
...
<td>初期表示(編集モード)</td>
<td><ul>
<li>成功時: <a href="../03_apis/API-project.md#API-PRJ-003">プロジェクト更新・削除</a> API(GET)で現値を取得し各入力欄に設定する。見出し(IT-01)を「プロジェクトを編集」に設定し、編集モード専用項目(IT-02 / IT-07 / IT-10 / IT-11)を表示する</li>
...
<td>「確認メールを再送」を押下</td>
<td><ul>
<li>成功時: <a href="../03_apis/API-auth.md#API-AUTH-011">連絡先確認メール再送</a> API を呼び出し、連絡先メール確認メールを再送信する</li>
