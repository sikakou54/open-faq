...
| 対応業務UC | [UC-164](../../01_requirements/02_business_usecases/UC-164.md#UC-164) ・ [UC-165](../../01_requirements/02_business_usecases/UC-165.md#UC-165) ・ [UC-166](../../01_requirements/02_business_usecases/UC-166.md#UC-166) ・ [UC-167](../../01_requirements/02_business_usecases/UC-167.md#UC-167) ・ [UC-168](../../01_requirements/02_business_usecases/UC-168.md#UC-168) ・ [UC-169](../../01_requirements/02_business_usecases/UC-169.md#UC-169) |
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-terms.md#API-TRM-001">利用規約 最新版取得</a></td>
</tr>
<tr>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-terms.md#API-TRM-002">プライバシーポリシー 最新版取得</a></td>
</tr>
<tr>
<td>利用規約 同意</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-terms.md#API-TRM-003">利用規約 同意</a></td>
</tr>
<tr>
<td>プライバシーポリシー 同意</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-terms.md#API-TRM-004">プライバシーポリシー 同意</a></td>
</tr>
</tbody>
</table>
...
<td>「同意して続行する」を押下</td>
<td><ul>
<li>成功時: 改定対象の文書のみを対象に API を呼び出し <code>T_TERMS_AGREE</code> に記録(利用規約が改定対象の場合は <a href="../03_apis/API-terms.md#API-TRM-003">利用規約 同意</a> API を、プライバシーポリシーが改定対象の場合は <a href="../03_apis/API-terms.md#API-TRM-004">プライバシーポリシー 同意</a> API を呼び出す。両文書が改定対象の場合は両 API を呼び出す)。完了後は割込み前の操作へ戻る</li>
