...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-004.md#API-004">パスワード再設定要求</a>(<code>POST /auth/password-reset-request</code>)</td>
</tr>
<tr>
<td>パスワード再設定確定</td>
...
<td>◯</td>
<td>—</td>
<td><a href="../03_apis/API-010.md#API-010">パスワード再設定確定</a>(<code>POST /auth/password-reset</code>)</td>
</tr>
</tbody>
</table>
...
<td><ul>
<li><a href="../03_apis/API-004.md#API-004">パスワード再設定要求</a> API を発行する</li>
...
<li>検証成功時: <a href="../03_apis/API-010.md#API-010">パスワード再設定確定</a> API を発行する。成功時はパスワードハッシュを更新し当該ユーザーの全セッションを失効させる</li>
