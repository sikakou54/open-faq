...
本画面が読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、API の正本は [API設計](../03_apis/index.md#API-AUTH-002) です。
...
<td>—</td>
<td>—</td>
<td><code>POST /auth/login</code>(<a href="../03_apis/API-auth.md#API-AUTH-002">ログイン</a>)</td>
</tr>
<tr>
