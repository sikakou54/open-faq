...
<td>—</td>
<td>—</td>
<td><code>POST /auth/invitations/{token}/preview</code>(<a href="../03_apis/API-auth.md#API-AUTH-007">招待トークン検証・プレビュー</a>)</td>
</tr>
<tr>
<td>アカウント有効化</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /auth/invitations/{token}/activate</code>(<a href="../03_apis/API-auth.md#API-AUTH-008">メンバーアカウント有効化</a>)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li><a href="../03_apis/API-auth.md#API-AUTH-007">招待トークン検証・プレビュー</a> API を実行</li>
