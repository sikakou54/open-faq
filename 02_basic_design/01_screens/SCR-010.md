...
本モーダルが読み書きするテーブル・ファイルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、API の正本は [API設計](../03_apis/API-faq.md) です。
...
<td>—</td>
<td>—</td>
<td><code>POST /faqs/import</code>(<a href="../03_apis/API-faq.md#API-FAQ-004">FAQ CSV インポート</a>)</td>
</tr>
<tr>
...
<td>—</td>
<td>—</td>
<td><code>GET /faqs/import/template</code>(<a href="../03_apis/API-faq.md#API-FAQ-005">FAQ インポートテンプレート取得</a>)</td>
</tr>
<tr>
<td>インポート CSV</td>
...
<td><a href="../03_apis/API-faq.md#API-FAQ-005">FAQ インポートテンプレート取得</a> API を呼び出し、ヘッダ行のみのテンプレート CSV をダウンロードする</td>
</tr>
<tr>
