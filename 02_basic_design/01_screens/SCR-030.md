...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/bootstrap</code>(<a href="../03_apis/index.md#API-037">API 設計 5.5.1</a>)</td>
</tr>
<tr>
<td>質問送信</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/ask</code>(<a href="../03_apis/API-038.md#API-038">ウィジェット質問送信</a>)</td>
</tr>
<tr>
<td>未解決質問登録</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/inquiries</code>(<a href="../03_apis/API-039.md#API-039">ウィジェット未解決質問登録</a>)</td>
</tr>
</tbody>
</table>
...
<td>処理エラーを受信</td>
<td><ul>
<li><a href="../03_apis/API-037.md#API-037">ウィジェット起動</a> または <a href="../03_apis/API-038.md#API-038">ウィジェット質問送信</a> API の処理エラー(通信障害・上流障害・認可エラー等)が発生した場合に発生する</li>
