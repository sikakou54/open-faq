<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-030 エンドユーザー向け FAQ ウィジェット**
<!-- /portal-top -->
...
| 対応業務UC | [UC-222](../../01_requirements/02_business_usecases/UC-222.md#UC-222) ・ [UC-223](../../01_requirements/02_business_usecases/UC-223.md#UC-223) ・ [UC-224](../../01_requirements/02_business_usecases/UC-224.md#UC-224) ・ [UC-225](../../01_requirements/02_business_usecases/UC-225.md#UC-225) ・ [UC-226](../../01_requirements/02_business_usecases/UC-226.md#UC-226) ・ [UC-227](../../01_requirements/02_business_usecases/UC-227.md#UC-227) ・ [UC-228](../../01_requirements/02_business_usecases/UC-228.md#UC-228) ・ [UC-229](../../01_requirements/02_business_usecases/UC-229.md#UC-229) |
...
本ウィジェットが呼び出す公開 API の一覧です。公開 API のベースは `/widget/v1/...`、正本は [API設計(ウィジェット API 群)](../03_apis/index.md)です(各 API の節は下表の行リンク先を正とします)。ウィジェットはサーバ経由でテーブルへアクセスし、直接の永続更新は行いません。
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/bootstrap</code>(<a href="../03_apis/index.md#API-WGT-001">API 設計 5.5.1</a>)</td>
</tr>
<tr>
<td>質問送信</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/ask</code>(<a href="../03_apis/API-widget.md#API-WGT-002">ウィジェット質問送信</a>)</td>
</tr>
<tr>
<td>未解決質問登録</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /widget/v1/inquiries</code>(<a href="../03_apis/API-widget.md#API-WGT-003">ウィジェット未解決質問登録</a>)</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><a href="../02_screen_events/EVT-222.md#EVT-222">EVT-222</a></td>
...
<tr>
<td><a href="../02_screen_events/EVT-223.md#EVT-223">EVT-223</a></td>
<td><code>EV-02</code></td>
<td><a href="#IT-01">IT-01</a></td>
<td>ランチャーバッジを押下</td>
<td><ul>
<li>バッジを非表示にしチャット UI を展開する(キーボード操作 Enter / Space キーによる起動も同等に扱う)</li>
<li><a href="../03_apis/API-widget.md#API-WGT-001">ウィジェット起動</a> API でセッションを確立し、ウィジェット設定(タイトル・連絡先メール等)を取得する</li>
<li>失敗時: エラーメッセージを会話欄に表示し、再試行案内を行う(連打防止付き)</li>
</ul></td>
</tr>
<tr>
<td><a href="../02_screen_events/EVT-224.md#EVT-224">EVT-224</a></td>
...
<tr>
<td><a href="../02_screen_events/EVT-225.md#EVT-225">EVT-225</a></td>
...
<tr>
<td><a href="../02_screen_events/EVT-226.md#EVT-226">EVT-226</a></td>
<td><code>EV-05</code></td>
<td><a href="#IT-06">IT-06</a></td>
<td>「送信」を押下</td>
<td><ul>
<li><a href="../03_apis/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API で質問を送信し、AI 回答を同じ会話欄に追加表示する</li>
...
<tr>
<td><a href="../02_screen_events/EVT-227.md#EVT-227">EVT-227</a></td>
<td><code>EV-06</code></td>
<td><a href="#IT-08">IT-08</a></td>
<td>AI 回答(未解決)を受信</td>
<td><ul>
<li><a href="../03_apis/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API のレスポンスが <code>type=unanswered</code> の場合に発生する(EV-05 の結果として続いて処理される)</li>
<li>回答できなかった旨をシステム返信として会話欄に追加表示する</li>
<li><a href="../03_apis/API-widget.md#API-WGT-003">ウィジェット未解決質問登録</a> API を呼び出し、質問ログと未解決質問を登録する</li>
...
<tr>
<td><a href="../02_screen_events/EVT-228.md#EVT-228">EVT-228</a></td>
<td><code>EV-07</code></td>
<td><a href="#IT-09">IT-09</a></td>
<td>受付制限(429)を受信</td>
<td><ul>
<li><a href="../03_apis/API-widget.md#API-WGT-002">ウィジェット質問送信</a> API から質問数上限到達または支払方法ゲートによる 429 を受信した場合に発生する(EV-05 の結果として続いて処理される)</li>
...
<tr>
<td><a href="../02_screen_events/EVT-229.md#EVT-229">EVT-229</a></td>
