<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-029 設定**
<!-- /portal-top -->
...
| 対応業務UC | [UC-215](../../01_requirements/02_business_usecases/UC-215.md#UC-215) ・ [UC-216](../../01_requirements/02_business_usecases/UC-216.md#UC-216) ・ [UC-217](../../01_requirements/02_business_usecases/UC-217.md#UC-217) ・ [UC-218](../../01_requirements/02_business_usecases/UC-218.md#UC-218) ・ [UC-219](../../01_requirements/02_business_usecases/UC-219.md#UC-219) ・ [UC-220](../../01_requirements/02_business_usecases/UC-220.md#UC-220) ・ [UC-221](../../01_requirements/02_business_usecases/UC-221.md#UC-221) |
...
本画面が読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、退会 API の正本は [API設計](../03_apis/index.md) です。退会の入力・確定処理は SCR-019 を正本とします。
...
<td>◯</td>
<td>—</td>
<td><code>M_CONTRACT</code>(<a href="../04_database/index.md#TBL-M-001">テーブル設計 3.2</a>)</td>
</tr>
<tr>
<td>契約設定取得</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-auth.md#API-AUTH-014">契約設定取得</a></td>
</tr>
<tr>
<td>契約設定更新</td>
...
<td>◯</td>
<td>—</td>
<td><a href="../03_apis/API-auth.md#API-AUTH-015">契約設定更新</a></td>
</tr>
<tr>
<td>退会申請</td>
...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-terms.md#API-TRM-005">退会申請</a></td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td>
<a href="../03_apis/API-auth.md#API-AUTH-014">契約設定取得</a> を呼び出し、契約名(IT-05)・連絡先メール(IT-01)・タイムゾーン(IT-06)を取得して各項目へ表示する。オーナー以外が URL 直アクセスした場合は権限不足を表示し本画面を描画しない。
</td>
</tr>
<tr>
...
<td>「変更を保存」を押下</td>
<td>
入力値を最終バリデーションのうえ、<a href="../03_apis/API-auth.md#API-AUTH-015">契約設定更新</a> を呼び出して連絡先メール・タイムゾーンを更新する。
<ul>
