...
<td>—</td>
<td>—</td>
<td><a href="../03_apis/API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a>(API-AUTH-009)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li>URL パスパラメータのトークンを取得し、<a href="../03_apis/API-auth.md#API-AUTH-009">プロジェクト連絡先メール確認</a> API (POST /auth/contact-verifications/{token}) を呼び出す</li>
