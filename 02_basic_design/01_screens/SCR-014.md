...
| 対応業務UC | [UC-123](../../01_requirements/02_business_usecases/UC-123.md#UC-123) ・ [UC-124](../../01_requirements/02_business_usecases/UC-124.md#UC-124) ・ [UC-125](../../01_requirements/02_business_usecases/UC-125.md#UC-125) ・ [UC-126](../../01_requirements/02_business_usecases/UC-126.md#UC-126) ・ [UC-127](../../01_requirements/02_business_usecases/UC-127.md#UC-127) ・ [UC-128](../../01_requirements/02_business_usecases/UC-128.md#UC-128) ・ [UC-129](../../01_requirements/02_business_usecases/UC-129.md#UC-129) ・ [UC-130](../../01_requirements/02_business_usecases/UC-130.md#UC-130) ・ [UC-131](../../01_requirements/02_business_usecases/UC-131.md#UC-131) ・ [UC-132](../../01_requirements/02_business_usecases/UC-132.md#UC-132) |
...
本モーダルが読み書きするテーブルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、API の正本は [API設計](../03_apis/API-member.md) です。
...
<td>◯</td>
<td>—</td>
<td><code>purpose='activation'</code>(7 日)。<code>T_ACCESS_TOKENS</code>(<a href="../04_database/index.md#TBL-T-002">テーブル設計 3.5</a>)</td>
</tr>
<tr>
<td>メンバー一覧</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /projects/{id}/members</code>(<a href="../03_apis/API-member.md#API-MBR-001">メンバー一覧</a>)</td>
</tr>
<tr>
<td>メンバー招待</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /projects/{id}/members</code>(<a href="../03_apis/API-member.md#API-MBR-002">メンバー招待</a>)</td>
</tr>
<tr>
<td>メンバー情報変更・割当解除</td>
...
<td>—</td>
<td>—</td>
<td>情報変更 <code>PATCH /projects/{id}/members/{userId}</code> / 割当解除 <code>DELETE /projects/{id}/members/{userId}</code>(<a href="../03_apis/API-member.md#API-MBR-003">メンバー情報更新</a> / <a href="../03_apis/API-member.md#API-MBR-004">プロジェクト割当解除</a>)</td>
</tr>
<tr>
<td>招待メール再送</td>
...
<td>—</td>
<td>—</td>
<td><code>POST /members/{id}/resend-invitation</code>(<a href="../03_apis/API-member.md#API-MBR-005">招待メール再送</a>)</td>
</tr>
</tbody>
</table>
...
<li><a href="../03_apis/API-member.md#API-MBR-001">メンバー一覧</a> API から対象メンバーの表示名・メールアドレス・招待状態を取得し各項目に初期値をセットする</li>
...
<li>成功時: <a href="../03_apis/API-member.md#API-MBR-002">メンバー招待</a> API で予約割当行とユーザーを作成し、有効化トークン(<code>T_ACCESS_TOKENS.purpose='activation'</code>、有効期限 7 日)を発行して招待メールを送信する。モーダルを閉じ SCR-013 の一覧を更新する</li>
...
<td><ul>
<li>成功時: <a href="../03_apis/API-member.md#API-MBR-005">招待メール再送</a> API で旧リンクを失効させ新トークン(有効期限 7 日)を発行し、招待メールを再送する。完了トーストを表示する</li>
