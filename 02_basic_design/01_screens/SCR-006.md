...
<td>—</td>
<td>—</td>
<td><code>GET /inquiries</code>(<code>status</code> / <code>projectId</code> / <code>cursor</code>)(<a href="../03_apis/API-034.md#API-034">未解決質問一覧</a>)</td>
</tr>
<tr>
...
<td>—</td>
<td>—</td>
<td><code>GET /inquiries/export</code>(<a href="../03_apis/API-036.md#API-036">未解決質問 CSV エクスポート</a>)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li><a href="../03_apis/API-034.md#API-034">未解決質問一覧</a> API を呼び出し、一覧を取得して表示する</li>
...
<td>状況フィルタをチェック</td>
<td><ul>
<li>チェック中の状況条件を付与して <a href="../03_apis/API-034.md#API-034">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
...
<td><ul>
<li>現在のフィルタ条件を付与して <a href="../03_apis/API-036.md#API-036">未解決質問 CSV エクスポート</a> API を呼び出し、レスポンスを CSV ファイルとしてダウンロードする</li>
...
<td>検索ボックスに入力</td>
<td><ul>
<li>入力されたフリーワードを条件として付与し、<a href="../03_apis/API-034.md#API-034">未解決質問一覧</a> API を再取得して一覧を更新する</li>
<li>結果が 0 件: <a href="#IT-09">IT-09</a> の空状態を表示する</li>
</ul></td>
</tr>
<tr>
...
<td>ページを選択</td>
<td><ul>
<li>選択したページの offset を付与して <a href="../03_apis/API-034.md#API-034">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
</ul></td>
</tr>
<tr>
