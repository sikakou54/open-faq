<!-- portal-top -->
[設計ポータル](../../README.md) ／ [基本設計](../index.md) ／ [画面設計](index.md) ／ **SCR-006 要対応の質問一覧**
<!-- /portal-top -->
...
| 対応業務UC | [UC-046](../../01_requirements/02_business_usecases/UC-046.md#UC-046) ・ [UC-047](../../01_requirements/02_business_usecases/UC-047.md#UC-047) ・ [UC-048](../../01_requirements/02_business_usecases/UC-048.md#UC-048) ・ [UC-049](../../01_requirements/02_business_usecases/UC-049.md#UC-049) ・ [UC-050](../../01_requirements/02_business_usecases/UC-050.md#UC-050) ・ [UC-051](../../01_requirements/02_business_usecases/UC-051.md#UC-051) ・ [UC-052](../../01_requirements/02_business_usecases/UC-052.md#UC-052) ・ [UC-053](../../01_requirements/02_business_usecases/UC-053.md#UC-053) |
...
本画面が読み書きするテーブル・ファイルと、呼び出す API の一覧です。テーブルの正本は [データベース設計](../04_database/index.md)、API の正本は [API設計](../03_apis/index.md) です。
...
<td>—</td>
<td>—</td>
<td><code>H_QUESTION_LOGS</code>(<a href="../04_database/index.md#TBL-H-001">テーブル設計 §2</a>)</td>
</tr>
<tr>
<td>未解決質問一覧取得</td>
...
<td>—</td>
<td>—</td>
<td><code>GET /inquiries</code>(<code>status</code> / <code>projectId</code> / <code>cursor</code>)(<a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a>)</td>
</tr>
<tr>
...
<td>—</td>
<td>—</td>
<td><code>GET /inquiries/export</code>(<a href="../03_apis/API-inquiry.md#API-INQ-003">未解決質問 CSV エクスポート</a>)</td>
</tr>
</tbody>
</table>
...
<td>初期表示</td>
<td><ul>
<li><a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を呼び出し、一覧を取得して表示する</li>
...
<td>状況フィルタをチェック</td>
<td><ul>
<li>チェック中の状況条件を付与して <a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
...
<td>期間フィルタを入力</td>
<td><ul>
<li>入力中の期間条件を付与して <a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
<li>結果が 0 件: <a href="#IT-09">IT-09</a> の空状態を表示する</li>
</ul></td>
</tr>
<tr>
...
<td>検索ボックスに入力</td>
<td><ul>
<li>入力されたフリーワードを条件として付与し、<a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得して一覧を更新する</li>
<li>結果が 0 件: <a href="#IT-09">IT-09</a> の空状態を表示する</li>
</ul></td>
</tr>
<tr>
...
<td>ページを選択</td>
<td><ul>
<li>選択したページの offset を付与して <a href="../03_apis/API-inquiry.md#API-INQ-001">未解決質問一覧</a> API を再取得し、一覧を更新する</li>
</ul></td>
</tr>
<tr>
