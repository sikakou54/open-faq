...
|---|---|
| SEQ ID | `SEQ-103` |
| 対応業務ユースケース | [UC-243](../../01_requirements/04_business_usecases/UC-243.md#UC-243) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-243](../../01_requirements/04_business_usecases/UC-243.md#UC-243)。画面イベントとの対応は UC-243 を参照。
