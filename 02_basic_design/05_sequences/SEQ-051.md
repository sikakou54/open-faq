...
|---|---|
| SEQ ID | `SEQ-051` |
| 対応業務ユースケース | [UC-130](../../01_requirements/04_business_usecases/UC-130.md#UC-130) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-130](../../01_requirements/04_business_usecases/UC-130.md#UC-130)。画面イベントとの対応は UC-130 を参照。
