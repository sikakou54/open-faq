...
|---|---|
| SEQ ID | `SEQ-085` |
| 対応業務ユースケース | [UC-215](../../01_requirements/04_business_usecases/UC-215.md#UC-215) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-215](../../01_requirements/04_business_usecases/UC-215.md#UC-215)。画面イベントとの対応は UC-215 を参照。
