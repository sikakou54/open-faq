...
|---|---|
| SEQ ID | `SEQ-096` |
| 対応業務ユースケース | [UC-236](../../01_requirements/04_business_usecases/UC-236.md#UC-236) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-236](../../01_requirements/04_business_usecases/UC-236.md#UC-236)。画面イベントとの対応は UC-236 を参照。
