...
| 画面イベント (EVT) | [EVT-217](../02_screen_events/EVT-217.md#EVT-217) |
...
| エラー (ERR) | [ERR-001](../07_errors/ERR-001.md#ERR-001) ・ [ERR-017](../07_errors/ERR-017.md#ERR-017) |
| メッセージ (MSG) | 要確認 |
...
- 入力値(メール形式・タイムゾーン識別子)が不正な場合は、該当項目にエラーを表示して送信しない([ERR-001](../07_errors/ERR-001.md#ERR-001))。
- オーナー以外の利用者が操作した場合は権限不足エラーとなり、入力値を保持してエラートーストを表示する([ERR-017](../07_errors/ERR-017.md#ERR-017))。
