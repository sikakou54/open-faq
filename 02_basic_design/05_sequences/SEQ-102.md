...
|---|---|
| SEQ ID | `SEQ-102` |
| 対応業務ユースケース | [UC-242](../../01_requirements/04_business_usecases/UC-242.md#UC-242) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-242](../../01_requirements/04_business_usecases/UC-242.md#UC-242)。画面イベントとの対応は UC-242 を参照。
