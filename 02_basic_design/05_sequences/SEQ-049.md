...
|---|---|
| SEQ ID | `SEQ-049` |
| 対応業務ユースケース | [UC-127](../../01_requirements/04_business_usecases/UC-127.md#UC-127) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-127](../../01_requirements/04_business_usecases/UC-127.md#UC-127)。画面イベントとの対応は UC-127 を参照。
