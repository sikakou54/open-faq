...
|---|---|
| SEQ ID | `SEQ-098` |
| 対応業務ユースケース | [UC-238](../../01_requirements/04_business_usecases/UC-238.md#UC-238) |
| 業務要件 (BR) | 要確認 |
...
- 図の出典は業務ユースケース [UC-238](../../01_requirements/04_business_usecases/UC-238.md#UC-238)。画面イベントとの対応は UC-238 を参照。
