...
|---|---|
| SEQ ID | `SEQ-001` |
| 対応業務ユースケース | [UC-001](../../01_requirements/02_business_usecases/UC-001.md#UC-001) |
...
- 図の出典は業務ユースケース [UC-001](../../01_requirements/02_business_usecases/UC-001.md#UC-001)。画面イベントとの対応は UC-001 を参照。
