...
|---|---|
| SEQ ID | `SEQ-093` |
| 対応業務ユースケース | [UC-233](../../01_requirements/02_business_usecases/UC-233.md#UC-233) |
| 関連画面 | — |
...
- 図の出典は業務ユースケース [UC-233](../../01_requirements/02_business_usecases/UC-233.md#UC-233)。画面イベントとの対応は UC-233 を参照。
