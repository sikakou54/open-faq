...
|---|---|
| SEQ ID | `SEQ-054` |
| 対応業務ユースケース | [UC-136](../../01_requirements/02_business_usecases/UC-136.md#UC-136) |
...
- 図の出典は業務ユースケース [UC-136](../../01_requirements/02_business_usecases/UC-136.md#UC-136)。画面イベントとの対応は UC-136 を参照。
