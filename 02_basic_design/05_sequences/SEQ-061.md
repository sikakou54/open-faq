...
|---|---|
| SEQ ID | `SEQ-061` |
| 対応業務ユースケース | [UC-144](../../01_requirements/02_business_usecases/UC-144.md#UC-144) |
...
- 図の出典は業務ユースケース [UC-144](../../01_requirements/02_business_usecases/UC-144.md#UC-144)。画面イベントとの対応は UC-144 を参照。
