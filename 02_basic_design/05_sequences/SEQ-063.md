...
|---|---|
| SEQ ID | `SEQ-063` |
| 対応業務ユースケース | [UC-147](../../01_requirements/02_business_usecases/UC-147.md#UC-147) |
...
- 図の出典は業務ユースケース [UC-147](../../01_requirements/02_business_usecases/UC-147.md#UC-147)。画面イベントとの対応は UC-147 を参照。
