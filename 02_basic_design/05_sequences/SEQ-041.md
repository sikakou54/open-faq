...
> **このページは、業務ユースケース UC-107（初期表示）のシーケンス図を定義します。**
...
|---|---|
| SEQ ID | `SEQ-041` |
| 対応業務ユースケース | [UC-107](../../01_requirements/04_business_usecases/UC-107.md#UC-107) |
| 業務要件 (BR) | 要確認 |
| 機能要件 (FR) | [FR-100](../../01_requirements/02_FunctionalRequirement/03_usage-fr.md#FR-100) |
| 画面イベント (EVT) | [EVT-107](../02_screen_events/EVT-107.md#EVT-107) |
...
- 図の出典は業務ユースケース [UC-107](../../01_requirements/04_business_usecases/UC-107.md#UC-107)。画面イベントとの対応は UC-107 を参照。
