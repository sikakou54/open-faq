...
| 画面イベント (EVT) | [EVT-105](../02_screen_events/EVT-105.md#EVT-105) |
...
- 権限不足: オーナー以外による更新は拒否し([ERR-017](../07_errors/ERR-017.md#ERR-017))、保存しない。
- 対象不正: 対象プロジェクトが存在しない / 境界違反の場合は拒否する([ERR-019](../07_errors/ERR-019.md#ERR-019))。
