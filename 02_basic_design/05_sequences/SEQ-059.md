...
|---|---|
| SEQ ID | `SEQ-059` |
| 対応業務ユースケース | [UC-142](../../01_requirements/02_business_usecases/UC-142.md#UC-142) |
...
- 図の出典は業務ユースケース [UC-142](../../01_requirements/02_business_usecases/UC-142.md#UC-142)。画面イベントとの対応は UC-142 を参照。
