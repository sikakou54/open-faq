...
|---|---|
| SEQ ID | `SEQ-009` |
| 対応業務ユースケース | [UC-028](../../01_requirements/02_business_usecases/UC-028.md#UC-028) |
...
- 図の出典は業務ユースケース [UC-028](../../01_requirements/02_business_usecases/UC-028.md#UC-028)。画面イベントとの対応は UC-028 を参照。
