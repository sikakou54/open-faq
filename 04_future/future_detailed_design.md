...
| 対応基本設計 | [future_basic_design.md](future_basic_design.md) |
| 作成日 | 2026-05-14 |
| 最終改訂日 | 2026-05-14 |
...
Future の移行・リリース設計候補は [operations.md](operations.md) の「Future 詳細設計 移行・リリース候補」へ移管した。
...
Future の Runbook 候補は [operations.md](operations.md) の「Future 詳細設計 Runbook 候補」へ移管した。
